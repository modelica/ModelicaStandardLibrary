...
equation
  ...
  connect(pipe2.port_a, traceSubstance2.port) annotation (Line(
      points={{56,-20},{54,-20},{54,4},{66,4}}, color={0,127,255}));
  ...
  connect(source1.ports[1], multiPort.port_a) annotation (Line(
      points={{-48,-18},{-42,-18}}, color={0,127,255}));
