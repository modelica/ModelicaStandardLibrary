...
extends Modelica.Icons.Library;
      ...
      extends Modelica.Icons.Example;
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/channel/kc_evenGapLaminar.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/channel/kc_evenGapLaminar_KC.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/channel/kc_evenGapOverall.mos"
  ...
  Modelica.Blocks.Sources.Exponentials input_mflow_2(
    ...
    riseTimeConst=1e-1) annotation (extent=[-40, -80; -20, -60], Placement(
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/channel/kc_evenGapOverall_KC.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/channel/kc_evenGapTurbulent.mos"
  ...
  SI.MassFlowRate m_flow[:]={mflow_test*eta[1]/eta[3],mflow_test*eta[2]/eta[3],
   ...
   SI.NusseltNumber Nu[n]={kc[i]*d_hyd/lambda[i] for i in 1:n};*/
          ...
          Modelica.SIunits.NusseltNumber Nu[n]=ones(n)*input_Nu.y;
          Modelica.SIunits.MassFlowRate m_flow[3](start=ones(n)*1e-2);
          Modelica.SIunits.CoefficientOfHeatTransfer kc_OUT_1[n]={Nu[i]*lambda[
              i]/d_hyd for i in 1:n};
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/channel/kc_evenGapTurbulent_KC.mos"
      ...
      extends Modelica.Icons.Example;
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/general/kc_approxForcedConvection.mos"
        ...
        public
          Modelica.Blocks.Sources.Ramp input_Nu(
            ...
            duration=1,
            height=1e6,
            offset=1000) annotation (extent=[-80, -80; -60, -60], Placement(
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/general/kc_approxForcedConvection_KC.mos"
      ...
      extends Modelica.Icons.Example;
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/heatExchanger/kc_flatTube.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/heatExchanger/kc_flatTube_KC.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/heatExchanger/kc_roundTube.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/heatExchanger/kc_roundTube_KC.mos"
      ...
      extends Modelica.Icons.Example;
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/helicalPipe/kc_laminar.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/helicalPipe/kc_laminar_KC.mos"
        ...
        equation
          ...
          annotation (
            Commands(file="./Resources/Scripts/Dymola/heatTransfer/helicalPipe/kc_overall.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/helicalPipe/kc_overall_KC.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/helicalPipe/kc_turbulent.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/helicalPipe/kc_turbulent_KC.mos"
      ...
      extends Modelica.Icons.Example;
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/plate/kc_laminar.mos"
                "Verification of kc_laminar"), Diagram(coordinateSystem(
                  preserveAspectRatio=true, extent={{-100,-100},{100,100}}), graphics={
                  Text(
                  extent={{-100,50},{100,75}},
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/plate/kc_laminar_KC.mos"
                "Verification of kc_laminar_KC"), Diagram(coordinateSystem(
                  preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics={
                   Text(
                  extent={{-100,50},{100,75}},
        ...
        equation
          ...
          annotation (
            Commands(file="./Resources/Scripts/Dymola/heatTransfer/plate/kc_overall.mos"
                "Verification of kc_overall"),
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/plate/kc_overall_KC.mos"
                "Verification of kc_overall_KC"), Diagram(coordinateSystem(
                  preserveAspectRatio=true, extent={{-100,-100},{100,100}}), graphics={
                  Text(
                  extent={{-100,50},{100,75}},
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/plate/kc_turbulent.mos"
                "Verification of kc_turbulent"), Diagram(coordinateSystem(
                  preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics={
                   Text(
                  extent={{-100,50},{100,75}},
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/plate/kc_turbulent_KC.mos"
                "Verification of kc_turbulent_KC"), Diagram(coordinateSystem(
                  preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics={
                   Text(
                  extent={{-100,50},{100,75}},
      ...
      extends Modelica.Icons.Example;
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/straightPipe/kc_laminar.mos"
                "Verification of kc_laminar"), Diagram(coordinateSystem(
                  preserveAspectRatio=true, extent={{-100,-100},{100,100}}), graphics={
                  Text(
                  extent={{-100,50},{100,75}},
        ...
        equation
          ...
          annotation (
            Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/straightPipe/kc_laminar_KC.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/straightPipe/kc_overall.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/straightPipe/kc_overall_KC.mos"
                "Verification of kc_overall_KC"), Diagram(coordinateSystem(
                  preserveAspectRatio=true, extent={{-100,-100},{100,100}}), graphics={
                  Text(
                  extent={{-100,50},{100,75}},
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/straightPipe/kc_turbulent.mos"
                "Verification of kc_turbulent"), Diagram(coordinateSystem(
                  preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics={
                   Text(
                  extent={{-100,50},{100,75}},
        ...
        model kc_turbulent_KC "Verification of function kc_turbulent_KC"
          ...
          //here: Nusselt number as input for reverse calculation
          Modelica.SIunits.NusseltNumber Nu[n]=ones(n)*input_Nu.y;
          Modelica.SIunits.MassFlowRate m_flow_1[3](start=ones(n)*1e-2);
          Modelica.SIunits.MassFlowRate m_flow_2[3](start=ones(n)*1e-2);
        ...
        public
          Modelica.Blocks.Sources.Ramp input_Nu(
            ...
            duration=1,
            height=1e4 - 1e1,
            offset=1e1) annotation (extent=[-80, -80; -60, -60], Placement(
                transformation(extent={{50,-80},{70,-60}})));
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/straightPipe/kc_turbulent_KC.mos"
                "Verification of kc_turbulent_KC"), Diagram(coordinateSystem(
                  preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics={
                   Text(
                  extent={{-100,5},{100,0}},
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/heatTransfer/straightPipe/kc_twoPhaseOverall_KC.mos"),
    ...
    extends Modelica.Icons.Example;
      ...
      extends Modelica.Icons.Example;
        model dp_curvedOverall "Verification of function dp_curvedOverall"
          ...
          Modelica.SIunits.MassFlowRate input_mdot_1[n](start=zeros(n))=ones(n)
            *input_mflow_0.y
          ...
          Modelica.SIunits.MassFlowRate input_mdot_2[m](start=zeros(m))=ones(m)
            *input_mflow_0.y
            "(Input) mass flow rate (for intended incompressible case)";
          Modelica.SIunits.Pressure input_dp_2[m]={DP_2[i] for i in 1:m}
            "(Input) pressure loss (for intended compressible case)";
          ...
          Modelica.Blocks.Sources.Sine input_mflow_1(
            ...
            startTime=0,
            freqHz=1,
            amplitude=100) annotation (extent=[-40, -80; -20, -60], Placement(
                transformation(extent={{-40,-80},{-20,-60}})));
          Modelica.Blocks.Sources.Exponentials input_mflow_2(
            offset=0,
            startTime=0,
        ...
        equation
          for i in 1:n loop
            (,M_FLOW_1[i],,,,) =
              Modelica.Fluid.Dissipation.PressureLoss.Bend.dp_curvedOverall(
                      dp_IN_con_1[i],
                      dp_IN_var_1[i],
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/bend/dp_curvedOverall.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/bend/dp_curvedOverall_DPMFLOW.mos"
        ...
        model dp_edgedOverall "Verification of function dp_edgedOverall"
          ...
          //target variables (here: mass flow rate as input for inverse calculation)
          //intended input variables for records
          Modelica.SIunits.MassFlowRate input_mdot[n](start=zeros(n))=ones(n)*
            input_mflow_0.y
            "(Input) mass flow rate (for intended incompressible case)";
          Modelica.SIunits.Pressure input_dp[n]={DP[i] for i in 1:n}
            "(Input) pressure loss (for intended compressible case)";
          ...
          Modelica.Blocks.Sources.Sine input_mflow_1(
            ...
            startTime=0,
            freqHz=1,
            amplitude=1e2) annotation (extent=[-40, -80; -20, -60], Placement(
                transformation(extent={{-40,-80},{-20,-60}})));
          Modelica.Blocks.Sources.Exponentials input_mflow_2(
            offset=0,
            startTime=0,
            riseTime=1e-2,
            riseTimeConst=1e-2,
            outMax=1e2) annotation (extent=[0, -80; 20, -60], Placement(transformation(
                  extent={{0,-80},{20,-60}})));
        ...
        equation
          for i in 1:n loop
            (,M_FLOW[i],,,,) =
              Modelica.Fluid.Dissipation.PressureLoss.Bend.dp_edgedOverall(
                      dp_IN_con[i],
                      dp_IN_var[i],
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/bend/dp_edgedOverall.mos"
      ...
      extends Modelica.Icons.Example;
        ...
        protected
          ...
          Modelica.SIunits.ReynoldsNumber Re_1[n]={rho*velocity_1[i]*d_hydT[i]/
              eta for i in 1:n};
        ...
        equation
          ...
          for i in 1:n loop
            (DP_1[i],,,,,) =
              Modelica.Fluid.Dissipation.PressureLoss.Channel.dp_internalFlowOverall(
                      m_flow_IN_con_1[i],
                      m_flow_IN_var_1[i],
                      chosenTarget_DP[i]);
          end for;
          ...
          annotation (
            Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/channel/dp_internalFlowOverall.mos"
        ...
        equation
          ...
          annotation (
            Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/channel/dp_internalFlowOverall_DPMFLOW.mos"
      ...
      extends Modelica.Icons.Example;
        model dp_idealGas "Verification of function dp_idealGas"
          ...
          Modelica.Blocks.Sources.Ramp input_mflow_0(
            ...
            offset=0,
            duration=1,
            height=1) annotation (extent=[-80, -80; -60, -60], Placement(transformation(
                  extent={{-80,-80},{-60,-60}})));
          Modelica.Blocks.Sources.Sine input_mflow_1(
            offset=0,
            phase=0,
            startTime=0,
            freqHz=1,
            amplitude=1) annotation (extent=[-40, -80; -20, -60], Placement(
                transformation(extent={{-40,-80},{-20,-60}})));
          Modelica.Blocks.Sources.Exponentials input_mflow_2(
            offset=0,
            startTime=0,
            riseTime=1e-2,
            riseTimeConst=1e-2,
            outMax=1) annotation (extent=[0, -80; 20, -60], Placement(transformation(
                  extent={{0,-80},{20,-60}})));
        ...
        equation
          for i in 1:n loop
            (,M_FLOW[i],,,,) =
              Modelica.Fluid.Dissipation.PressureLoss.General.dp_idealGas(
                      dp_IN_con[i],
                      dp_IN_var[i],
                      chosenTarget_MFLOW[i]);
          end for;
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/general/dp_idealGas.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/general/dp_idealGas_DPMFLOW.mos"
        ...
        model dp_nominalDensityViscosity
          ...
          Modelica.Fluid.Dissipation.PressureLoss.General.dp_nominalDensityViscosity_IN_con
            ...
            each rho_nom=rho_nom) annotation (extent=[-60, 20; -40, 42], Placement(
                transformation(extent={{30,20},{50,42}})));

          Modelica.Fluid.Dissipation.PressureLoss.General.dp_nominalDensityViscosity_IN_var
            dp_IN_var[n](eta=eta, rho=rho) annotation (extent=[-60, 20; -40, 42],
          ...
          Modelica.Fluid.Dissipation.PressureLoss.General.dp_nominalDensityViscosity_IN_var
            m_flow_IN_var[n](eta=eta, rho=rho) annotation (extent=[40, 20; 60, 42],
        ...
        equation
          for i in 1:n loop
            (,M_FLOW[i],,,,) =
              Modelica.Fluid.Dissipation.PressureLoss.General.dp_nominalDensityViscosity(
                      dp_IN_con[i],
                      dp_IN_var[i],
                      chosenTarget_MFLOW[i]);
          end for;
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/general/dp_nominalDensityViscosity.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/general/dp_nominalDensityViscosity_DPMFLOW.mos"
        ...
        model dp_nominalPressureLossLawDensity
          ...
          Modelica.Fluid.Dissipation.PressureLoss.General.dp_nominalPressureLossLawDensity_IN_con
            ...
            each target=target) annotation (extent=[40, 20; 60, 42], Placement(
                transformation(extent={{-70,20},{-50,42}})));
        ...
        equation
          for i in 1:n loop
            (,M_FLOW[i],,,,) =
              Modelica.Fluid.Dissipation.PressureLoss.General.dp_nominalPressureLossLawDensity(
                      dp_IN_con[i],
                      dp_IN_var[i],
                      chosenTarget_MFLOW[i]);
          end for;
          ...
          annotation (
            Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/general/dp_nominalPressureLossLawDensity.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/general/dp_nominalPressureLossLawDensity_DPMFLOW.mos"
        ...
        equation
          for i in 1:n loop
            (,M_FLOW[i],,,,) =
              Modelica.Fluid.Dissipation.PressureLoss.General.dp_pressureLossCoefficient(
                      dp_IN_con[i],
                      dp_IN_var[i],
                      chosenTarget_MFLOW[i]);
          end for;
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/general/dp_pressureLossCoefficient.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/general/dp_pressureLossCoefficient_DPMFLOW.mos"
        ...
        equation
          for i in 1:n loop
            (,M_FLOW[i],,,,) =
              Modelica.Fluid.Dissipation.PressureLoss.General.dp_volumeFlowRate(
                      dp_IN_con[i],
                      dp_IN_var[i],
                      chosenTarget_MFLOW[i]);
          end for;
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/general/dp_volumeFlowRate.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/general/dp_volumeFlowRate_DPMFLOW.mos"
      ...
      extends Modelica.Icons.Example;
        ...
        model dp_suddenChange
          ...
          //intended input variables for records
          Modelica.SIunits.MassFlowRate input_mdot(start=0)=m_flowoo*
            input_mflow_0.y
            "(Input) mass flow rate (for intended incompressible case)";
          Modelica.SIunits.Pressure input_dp=DP
            "(Input) pressure loss (for intended compressible case)";
          ...
          Modelica.Blocks.Sources.Ramp input_mflow_0(
            ...
            duration=1,
            offset=0,
            height=400) annotation (extent=[-80, -80; -60, -60], Placement(
                transformation(extent={{-80,-80},{-60,-60}})));
          Modelica.Blocks.Sources.Sine input_mflow_1(
            phase=0,
            startTime=0,
            freqHz=1,
            amplitude=200,
            offset=200) annotation (extent=[-40, -80; -20, -60], Placement(
                transformation(extent={{-40,-80},{-20,-60}})));
          Modelica.Blocks.Sources.Exponentials input_mflow_2(
            offset=0,
            startTime=0,
            riseTime=1e-2,
            riseTimeConst=1e-2,
            outMax=400) annotation (extent=[0, -80; 20, -60], Placement(transformation(
                  extent={{0,-80},{20,-60}})));
        equation
          //orifice variables
          der(frac_A1toA2) = 1;
          ...
          //incompressible fluid flow
          (DP,,zeta_TOT,,,) =
            Modelica.Fluid.Dissipation.PressureLoss.Orifice.dp_suddenChange(
                    m_flow_IN_con,
                    m_flow_IN_var,
                    chosenTarget_DP);
          ...
          annotation (
            Commands(file="./Resources/Scripts/Dymola/pressureLoss/orifice/dp_suddenChange.mos"
        ...
        equation
          ...
          annotation (
            Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/orifice/dp_suddenChange_DPMFLOW.mos"
        ...
        model dp_thickEdgedOverall
          "Verification of function dp_thickEdgedOverall"
        ...
        equation
          ...
          for i in 1:n loop
            (,M_FLOW[i],,,,) =
              Modelica.Fluid.Dissipation.PressureLoss.Orifice.dp_thickEdgedOverall(
                      dp_IN_con[i],
                      dp_IN_var[i],
                      chosenTarget_MFLOW[i]);
          end for;
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/orifice/dp_thickEdgedOverall.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/orifice/dp_thickEdgedOverall_DPMFLOW.mos"
      ...
      extends Modelica.Icons.Example;
        ...
        equation
          for i in 1:n loop
            (,M_FLOW[i],,,,) =
              Modelica.Fluid.Dissipation.PressureLoss.StraightPipe.dp_laminar(
                      dp_IN_con[i],
                      dp_IN_var[i],
                      chosenTarget_MFLOW[i]);
          end for;
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/straightPipe/dp_laminar.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/straightPipe/dp_laminar_DPMFLOW.mos"
        ...
        equation
          for i in 1:n loop
            (,M_FLOW[i],,,,) =
              Modelica.Fluid.Dissipation.PressureLoss.StraightPipe.dp_overall(
                      dp_IN_con[i],
                      dp_IN_var[i],
                      chosenTarget_MFLOW[i]);
          end for;
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/straightPipe/dp_overall.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/straightPipe/dp_overall_DPMFLOW.mos"
                "Verification of dp_overall_DPMFLOW"), Diagram(coordinateSystem(
                  preserveAspectRatio=true, extent={{-100,-100},{100,100}}), graphics={
                  Text(
                  extent={{-100,-50},{100,-25}},
        ...
        equation
          for i in 1:n loop
            (,M_FLOW[i],,,,) =
              Modelica.Fluid.Dissipation.PressureLoss.StraightPipe.dp_turbulent(
                      dp_IN_con[i],
                      dp_IN_var[i],
                      chosenTarget_MFLOW[i]);
          end for;
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/straightPipe/dp_turbulent.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/straightPipe/dp_turbulent_DPMFLOW.mos"
        ...
        equation
          ...
          annotation (Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/straightPipe/dp_twoPhaseOverall_DP.mos"
      ...
      extends Modelica.Icons.Example;
        ...
        equation
          ...
          annotation (
            Commands(file=
                  "./Resources/Scripts/Dymola/pressureLoss/valve/dp_severalGeometryOverall_DPMFLOW.mos"
  ...
  package TestCases "package for implemented test cases ready for simulation"
    ...
    model EngineFeedingSystem "Test cases of an aircraft engine feeding system"
      ...
      inner Modelica.Fluid.System system(
        ...
        m_flow_small=0.01,
        allowFlowReversal=false) annotation (extent=[80, -100; 100, -80]);
      ...
      Modelica.Fluid.Fittings.PressureLoss.StraightPipeFlowModel pipe_1(
                                                             redeclare package
      ...
      Modelica.Fluid.Fittings.PressureLoss.StraightPipeFlowModel pipe_3(
                                                             redeclare package
          Medium = Modelica.Media.Water.ConstantPropertyLiquidWater) annotation (
          Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=270,
            origin={-40,-56})));
      Modelica.Fluid.Fittings.PressureLoss.StraightPipeFlowModel pipe_6(
                                                             redeclare package
          Medium = Modelica.Media.Water.ConstantPropertyLiquidWater) annotation (
          Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=270,
            origin={20,-56})));
      Modelica.Fluid.Fittings.PressureLoss.StraightPipeFlowModel pipe_2(
                                                             redeclare package
          Medium = Modelica.Media.Water.ConstantPropertyLiquidWater) annotation (
          Placement(transformation(
            extent={{-10,-10},{10,10}},
...
"),     experiment(StopTime=2000, NumberOfIntervals=5000),
    ...
    extends Modelica.Fluid.Icons.VariantLibrary;
      ...
      model Channel "Test case for heat transfer of channel"
        ...
        //  inner Medium.ThermodynamicState state=medium.state;

        //  SI.Pressure p_state=pressure.y;
        //  SI.Temp_K T_state=temperature.y + 273.15;

        Modelica.Fluid.Fittings.HeatTransfer.ChannelHeatTransferModel channel(
      ...
      model HeatExchanger "Test case for heat transfer of heat exchanger"
        ...
        Modelica.Fluid.Fittings.HeatTransfer.HeatExchangerHeatTransferModel
          heatExchanger(
          m_flow=massFlowRate.y,
          redeclare package Medium = Modelica.Media.Air.DryAirNasa,
      ...
      model HelicalPipe "Test case for heat transfer of helical pipe"
        ...
        Modelica.Fluid.Fittings.HeatTransfer.HelicalPipeHeatTransferModel
          helicalPipe(
          m_flow=massFlowRate.y,
          fluidFlowRegime=2,
          n_nt=10,
  ...
  SI.Temp_K T_state=temperature.y + 273.15;*/
        ...
        Modelica.Fluid.Fittings.HeatTransfer.StraightPipeHeatTransferModel
          straightPipe(
          m_flow=massFlowRate.y,
          fluidFlowRegime=2,
          redeclare package Medium = Modelica.Media.Air.DryAirNasa)
...
"),       experiment(StopTime=1.01, NumberOfIntervals=5000),
      ...
      model StraightPipe
        "Test cases of pressure loss functions for straight pipes"
