    ...
    annotation (
      ...
      Icon(coordinateSystem(
          ...
          Line(
            ...
            color={0,0,0}, 
            thickness=4), 
          Text(extent={{-150,-124},{164,-186}}, textString=
                                                    "%name"), 
          Line(
  ...
  model CylinderBase "One cylinder with analytic handling of kinematic loop" 
    ...
    annotation (
      ...
      Icon(coordinateSystem(
          ...
          grid={1,1}), graphics={
          Polygon(
            points={{-60,-61},{-60,64},{60,64},{60,-61},{100,-61},{100,114},{
                -100,114},{-100,-61},{-60,-61}}, 
            lineColor={0,0,0}, 
            fillColor={192,192,192}, 
            fillPattern=FillPattern.Solid), 
          Rectangle(
          ...
          Line(
            ...
            color={0,0,0}, 
            thickness=4), 
          Text(extent={{-156,178},{158,116}}, textString=
                                                  "%name"), 
          Line(
...
<IMG SRC=\"../Images/MultiBody/Examples/Loops/Engine.png\" ALT=\"model Examples.Loops.Engine\">
    ...
    Modelica.Mechanics.Rotational.Inertia Inertia(
      ...
      phi(
        ...
        start=0.001))                    annotation (Placement(transformation(
