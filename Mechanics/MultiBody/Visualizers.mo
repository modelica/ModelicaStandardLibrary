...
"),   Icon(coordinateSystem(
          ...
          grid={1,1}), graphics={
          Polygon(
            points={{-100,33},{-100,-61},{-10,-41},{50,-61},{50,33},{-10,11},{
                -100,33}}, 
            lineColor={0,127,255}, 
            fillColor={0,127,255}, 
          ...
          Text(
            ...
            textString=
                 "%shapeType"), 
          Text(extent={{-131,118},{129,58}}, textString=
                                                 "%name")}),
  ...
  model FixedShape2 
    ...
    annotation (
      ...
      Icon(coordinateSystem(
          ...
          extent={{-100,-100},{100,100}}, 
          grid={1,1}), graphics={
          Text(extent={{-123,128},{137,68}}, textString=
                                                 "%name"), 
          Text(
            ...
            textString=
                 "%=r"), 
          Polygon(
            points={{-100,50},{-100,-44},{-10,-24},{79,-43},{80,49},{-10,28},{
                -100,50}}, 
            lineColor={0,127,255}, 
            fillColor={0,127,255}, 
            fillPattern=FillPattern.Solid), 
    ...
    annotation (
      ...
      Icon(coordinateSystem(
          ...
          Polygon(points={{-98,-68},{-66,-60},{-78,-46},{-98,-68}}, fillPattern
              =FillPattern.Solid), 
          Text(extent={{-87,13},{-38,-36}}, textString=
                                                "z"), 
          Text(
    ...
    annotation (
      ...
      Icon(graphics={
          ...
          Polygon(
            ...
            fillColor={128,128,128}, 
            fillPattern=FillPattern.Solid), 
          Text(extent={{-146,124},{142,62}}, textString=
                                                 "%name"), 
          Text(
      ...
      annotation (
        ...
        Icon(coordinateSystem(
            ...
            Text(
              ...
              textString=
                   "%shapeType"), 
            Text(extent={{-132,160},{128,100}}, textString=
                                                    "%name")}),
        Window(
          x=0.28,
          y=0.06,
      ...
      annotation (
        ...
        Icon(graphics={
            Rectangle(
              ...
              fillColor={255,255,255}, 
              fillPattern=FillPattern.Solid), 
            Text(extent={{-140,164},{148,102}}, textString=
                                                    "%name"), 
            Polygon(
