...
"));
    ...
    annotation (
      ...
      Diagram(
        ...
        Line(points=[-40, 0; -31.6, 34.2; -26.1, 53.1; -21.3, 66.4; -17.1, 
              ...
              63.1, -61.9; 67.9, -47.2; 74, -24.8; 80, 0], style(color=0, 
              thickness=2)), 
  ...
  model PulseVoltage "Pulse voltage source" 
    ...
    extends Modelica.Electrical.Analog.Interfaces.VoltageSource(redeclare 
        ...
        period={period}));
    annotation (
      Icon(Line(points=[-70, -70; -40, -70; -40, 70; 0, 70; 0, -70; 40, -70; 
              41, 70; 80, 70], style(color=8))), 
      Diagram(
        Polygon(points=[-80, 90; -88, 68; -72, 68; -80, 90], style(color=8, 
              fillColor=8)), 
        Line(points=[-80, 68; -80, -80], style(color=8)), 
        ...
        Line(points=[-80, 0; -20, 0; -21, 50; 21, 50; 20, -1; 41, 0; 40, 50; 
              80, 51], style(color=0, thickness=2)), 
