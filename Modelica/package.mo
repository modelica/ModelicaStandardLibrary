...
<ol>
<li> State the relevant balance equations of a volume
     for the particular physical domain. </li>
<li> Simplify the balance equations of (1) by taking the
     limit of an infinitesimal volume.</li>
<li> Use the variables needed for the balance equations of (2)
     in the connector and select appropriate Modelica
     <b>prefixes</b>, so that the balance equations of (2)
