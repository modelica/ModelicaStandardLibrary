...
<body lang=\"en-US\">
    <p>All files in this directory (&ldquo;Modelica&rdquo;) and in all
    subdirectories, especially all files that build package
    &ldquo;Modelica&rdquo; and the contents of the directory
    &ldquo;Modelica/Resources&rdquo; are licensed by the <strong>Modelica
    Association</strong> under the &ldquo;Modelica License&nbsp;2&rdquo; (with
    exception of the contents of the directory
    &ldquo;Modelica/Resources/C-Sources&rdquo;).</p>
