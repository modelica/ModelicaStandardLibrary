...
- ModelicaExternalC (.lib, .dll, .a, .so, depending on tool) containing:
  ModelicaInternal.c
  ModelicaStrings.c
  win32_dirent.c (for windows)

- ModelicaStandardTables (.lib, .dll, .a, .so, depending on tool) containing:
