...
model GenerationOfFMUs
  ...
  Modelica.Mechanics.Translational.Examples.Utilities.DirectMass directMass(m=1.1)
    annotation (Placement(transformation(extent={{0,40},{20,60}})));
  Modelica.Mechanics.Translational.Examples.Utilities.InverseMass inverseMass(m=2.2)
    annotation (Placement(transformation(extent={{40,40},{60,60}})));
  Modelica.Mechanics.Translational.Examples.Utilities.SpringDamper springDamper(c=1e4, d=
  ...
  Modelica.Mechanics.Translational.Components.GeneralForceToPositionAdaptor forceToPosition2a(use_pder2=
       false) annotation (Placement(transformation(extent={{-10,-20},{10,0}})));
  Modelica.Mechanics.Translational.Components.Mass mass2b(
    m=2.2,
    s(fixed=true, start=0),
    v(fixed=true, start=0))
    annotation (Placement(transformation(extent={{70,-20},{90,0}})));
  Modelica.Mechanics.Translational.Components.GeneralForceToPositionAdaptor forceToPosition2b(use_pder2=
  ...
  Modelica.Mechanics.Translational.Components.GeneralForceToPositionAdaptor forceToPosition3a(use_pder=
  ...
  Modelica.Mechanics.Translational.Components.GeneralForceToPositionAdaptor forceToPosition3b(use_pder=
        false, use_pder2=false)
