...
model Spring "Input/output block of a spring model"
  ...
  Modelica.Mechanics.Translational.Components.GeneralPositionToForceAdaptor positionToForce1(use_pder=
  ...
  Modelica.Mechanics.Translational.Components.Spring spring(c=c, s_rel0=s_rel0)
  ...
  Modelica.Blocks.Interfaces.RealOutput f2(unit="N")
    "Force generated by the force element"
    annotation (Placement(transformation(extent={{100,-90},{120,-70}})));
  Modelica.Mechanics.Translational.Components.GeneralPositionToForceAdaptor positionToForce2(use_pder=
        false, use_pder2=false)
    annotation (Placement(transformation(extent={{30,-10},{10,10}})));
equation
