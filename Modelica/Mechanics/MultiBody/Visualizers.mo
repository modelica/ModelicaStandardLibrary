      ...
      annotation (
        ...
        Icon(
          ...
          graphics = {
            ...
            Polygon(origin = {6, 0}, points={{-6,102},{-14,72},{2,72},{-6,102}}, fillPattern=FillPattern.Solid), Text(textColor = {64, 64, 64}, extent = {{-150, -145}, {150, -105}}, textString = "%name")}),
        Documentation(info = "<html>
<p>
...
<img src=\"modelica://Modelica/Resources/Images/Mechanics/MultiBody/Visualizers/Ground.png\">
  ...
  equation
    ...
    annotation(
      Icon(
        graphics = {
          Text(textColor = {64, 64, 64}, extent = {{-150, 100}, {150, 140}}, textString = "%name"),
...
<!--a placeholder to fulfill minimum documentation length-->
  ...
  equation
    ...
    annotation(
      Icon(
        graphics = {
          Text(textColor = {64, 64, 64}, extent = {{-150, 50}, {150, 90}}, textString = "%name"),
...
<!--a placeholder to fulfill minimum documentation length-->
    ...
    protected
      ...
      annotation(Icon(graphics = {Text(textColor = {64, 64, 64}, extent = {{-150, 54}, {150, 94}}, textString = "%name"),
...
</html>"), Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, initialScale = 0.1, grid = {10, 10}), graphics = {Polygon(origin = {4.391, -1}, lineColor = {128, 128, 128}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, points = {{-14.391, 86}, {75.609, 66}, {15.609, 26}, {-84.391, 56}}),
