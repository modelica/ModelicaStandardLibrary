...
package Noise "Library of noise blocks"
  ...
  model GlobalSeed
    ...
    final parameter Integer seed = if useAutomaticSeed then Modelica.Math.Random.Utilities.automaticGlobalSeed() else fixedSeed "Actually used global seed";
    final parameter Integer id_impure = Modelica.Math.Random.Utilities.initializeImpureRandom(seed)
