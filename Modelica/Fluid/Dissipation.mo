...
package Dissipation
  ...
  import REC = Dissipation.Utilities.Records;
  import SI = Modelica.SIunits;
  import TYP = Dissipation.Utilities.Types;
...
<ul>
<li> <p>Changed flow models structure:</p>
<p>Now that a future feature for the automatic choice of using either a mass flow rate
  ...
  extends Modelica.Icons.VariantsPackage;
    ...
    extends Modelica.Icons.VariantsPackage;
      ...
      function kc_evenGapLaminar
        ...
        //icon
        extends Dissipation.Utilities.Icons.HeatTransfer.Gap1_d;

        //input records
        input Dissipation.HeatTransfer.Channel.kc_evenGapLaminar_IN_con IN_con
          "Input record for function kc_evenGapLaminar" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.HeatTransfer.Channel.kc_evenGapLaminar_IN_var IN_var
          "Input record for function kc_evenGapLaminar" 
      ...
      protected
        type TYP = Dissipation.Utilities.Types.kc_evenGap;
      ...
      algorithm
        ...
        kc := Dissipation.HeatTransfer.Channel.kc_evenGapLaminar_KC(IN_con,
          IN_var);
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2);
      ...
      record kc_evenGapLaminar_IN_con
        ...
        extends Dissipation.HeatTransfer.Channel.kc_evenGapOverall_IN_con;
...
<a href=\"modelica://Modelica.Fluid.Dissipation.HeatTransfer.Channel.kc_evenGapLaminar_KC\"> kc_evenGapLaminar_KC</a>.
      ...
      record kc_evenGapLaminar_IN_var
        ...
        extends Dissipation.HeatTransfer.Channel.kc_evenGapOverall_IN_var;
...
<a href=\"modelica://Modelica.Fluid.Dissipation.HeatTransfer.Channel.kc_evenGapLaminar_KC\"> kc_evenGapLaminar_KC</a>.
      ...
      function kc_evenGapOverall
        ...
        //input records
        input Dissipation.HeatTransfer.Channel.kc_evenGapOverall_IN_con IN_con
          "Input record for function kc_evenGapOverall" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.HeatTransfer.Channel.kc_evenGapOverall_IN_var IN_var
          "Input record for function kc_evenGapOverall" 
          annotation (Dialog(group="Variable inputs"));
      ...
      algorithm
        ...
        kc := Dissipation.HeatTransfer.Channel.kc_evenGapOverall_KC(IN_con, IN_var);
        Nu := kc*d_hyd/max(MIN, IN_var.lambda);
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2);
      ...
      function kc_evenGapOverall_KC
        ...
        import SMOOTH = Dissipation.Utilities.Functions.General.Stepsmoother;
      ...
      algorithm
        kc := SMOOTH(
                laminar, 
                turbulent, 
                Re)*kc_evenGapLaminar_KC(IN_con, IN_var) + SMOOTH(
                turbulent, 
                laminar, 
                Re)*kc_evenGapTurbulent_KC(IN_con, IN_var);
      annotation (Documentation(info="<html>
<p>
Calculation of the mean convective heat transfer coefficient <b> kc </b> for an overall fluid flow through an even gap at different fluid flow and heat transfer situations. <a href=\"modelica://Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.HeatTransfer.Channel.kc_evenGapOverall\">See more information.</a>
</p>
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2);
      ...
      record kc_evenGapOverall_IN_con
        ...
        //even gap variables
        extends Dissipation.Utilities.Records.HeatTransfer.EvenGap;
...
<a href=\"modelica://Modelica.Fluid.Dissipation.HeatTransfer.Channel.kc_evenGapOverall_KC\"> kc_evenGapOverall_KC</a>.
      ...
      record kc_evenGapOverall_IN_var
        ...
        extends Dissipation.Utilities.Records.General.FluidProperties;
...
<a href=\"Modelica://Modelica.Fluid.Dissipation.HeatTransfer.Channel.kc_evenGapOverall_KC\"> kc_evenGapOverall_KC</a>.
      ...
      function kc_evenGapTurbulent
        ...
        //input records
        input Dissipation.HeatTransfer.Channel.kc_evenGapTurbulent_IN_con
          IN_con "Input record for function kc_evenGapTurbulent" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.HeatTransfer.Channel.kc_evenGapTurbulent_IN_var
      ...
      algorithm
        Pr := abs(IN_var.eta*IN_var.cp/max(MIN, IN_var.lambda));
        Re := max(1, abs(IN_var.rho*velocity*d_hyd/max(MIN, IN_var.eta)));
        kc := Dissipation.HeatTransfer.Channel.kc_evenGapTurbulent_KC(IN_con,
          IN_var);
        Nu := kc*d_hyd/max(MIN, IN_var.lambda);
...
<p>Calculation of the mean convective heat transfer coefficient <b>kc </b>for a laminar fluid flow through an even gap at different fluid flow and heat transfer situations. <a href=\"modelica://Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.HeatTransfer.Channel.kc_evenGapOverall\">See more information.</a></p>
    ...
    extends Modelica.Icons.VariantsPackage;
      function kc_approxForcedConvection
        ...
        //input records
        input Dissipation.HeatTransfer.General.kc_approxForcedConvection_IN_con
          IN_con "Input record for function kc_approxForcedConvection" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.HeatTransfer.General.kc_approxForcedConvection_IN_var
      ...
      protected
        type TYP = Dissipation.Utilities.Types.kc_general;
      ...
      algorithm
        Pr := Dissipation.Utilities.Functions.General.PrandtlNumber(
                IN_var.cp, 
                IN_var.eta, 
                IN_var.lambda);
        Re := max(1, Dissipation.Utilities.Functions.General.ReynoldsNumber(
                IN_con.A_cross, 
                IN_con.perimeter, 
                IN_var.rho, 
                IN_var.eta, 
                abs(IN_var.m_flow))) "Reynolds number";
        kc := Dissipation.HeatTransfer.General.kc_approxForcedConvection_KC(
          IN_con, IN_var);
        Nu := kc*d_hyd/max(MIN, IN_var.lambda);
...
<a href=\"modelica://Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.HeatTransfer.General.kc_approxForcedConvection\">See more information</a> .
      ...
      record kc_approxForcedConvection_IN_con
        ...
        //generic variables
        extends Dissipation.Utilities.Records.HeatTransfer.General                     annotation (
...
<p>Approximate calculation of the mean convective heat transfer coefficient <b> kc </b> for forced convection with a fully developed fluid flow in a turbulent regime. <a href=\"modelica://Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.HeatTransfer.General.kc_approxForcedConvection\">See more information.</a> </p>
    ...
    extends Modelica.Icons.VariantsPackage;
      function kc_flatTube
        ...
        //input records
        input Dissipation.HeatTransfer.HeatExchanger.kc_flatTube_IN_con IN_con
          "Input record for function kc_flatTube" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.HeatTransfer.HeatExchanger.kc_flatTube_IN_var IN_var
          "Input record for function kc_flatTube" 
          annotation (Dialog(group="Variable inputs"));
      ...
      protected
        type TYP = 
            Dissipation.Utilities.Types.HTXGeometry_flatTubes;
        ...
        SI.Length t=if IN_con.geometry == TYP.RectangularFin then s*IN_con.gamma else 
                  0 "Fin thickness";
      algorithm
        kc := Dissipation.HeatTransfer.HeatExchanger.kc_flatTube_KC(IN_con,
          IN_var);
...
"),          smoothOrder(__Dymola_normallyConstant=IN_con) = 2);
      ...
      public
        Dissipation.Utilities.Types.HTXGeometry_flatTubes geometry=Dissipation.Utilities.Types.HTXGeometry_flatTubes.LouverFin
...
<a href=\"modelica://Modelica.Fluid.Dissipation.HeatTransfer.HeatExchanger.kc_flatTube_KC\"> kc_flatTube_KC</a>.
      ...
      function kc_roundTube
        ...
        //input records
        input Dissipation.HeatTransfer.HeatExchanger.kc_roundTube_IN_con IN_con
          "Input record for function kc_roundTube" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.HeatTransfer.HeatExchanger.kc_roundTube_IN_var IN_var
          "Input record for function kc_roundTube" 
          annotation (Dialog(group="Variable inputs"));
      ...
      protected
        type TYP = 
            Dissipation.Utilities.Types.HTXGeometry_roundTubes;
    ...
    if IN_con.geometry==2 then
      ...
      algorithm
        kc := Dissipation.HeatTransfer.HeatExchanger.kc_roundTube_KC(IN_con,
          IN_var);
        Pr := abs(IN_var.eta*IN_var.cp/IN_var.lambda);
...
"),          smoothOrder(__Dymola_normallyConstant=IN_con) = 2);
      ...
      record kc_roundTube_IN_con
        ...
        Dissipation.Utilities.Types.HTXGeometry_roundTubes geometry=Dissipation.Utilities.Types.HTXGeometry_roundTubes.PlainFin
          "Choice of fin geometry" annotation (Dialog(group="HeatExchanger"));
...
"));
    ...
    extends Modelica.Icons.VariantsPackage;
      function kc_laminar
        ...
        //icon
        extends Dissipation.Utilities.Icons.HeatTransfer.HelicalPipe1_d;

        //input records
        input Dissipation.HeatTransfer.HelicalPipe.kc_laminar_IN_con IN_con
          "Input record for function kc_laminar" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.HeatTransfer.HelicalPipe.kc_laminar_IN_var IN_var
          "Input record for function kc_laminar" 
          annotation (Dialog(group="Variable inputs"));
      ...
      algorithm
        ...
        kc := Dissipation.HeatTransfer.HelicalPipe.kc_laminar_KC(IN_con, IN_var);
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2);
      ...
      record kc_laminar_IN_con
        ...
        extends Dissipation.HeatTransfer.HelicalPipe.kc_overall_IN_con;
...
<a href=\"Modelica://Modelica.Fluid.Dissipation.HeatTransfer.HelicalPipe.kc_laminar_KC\"> kc_laminar_KC</a>.
      ...
      record kc_laminar_IN_var
        ...
        extends Dissipation.HeatTransfer.HelicalPipe.kc_overall_IN_var;
...
<a href=\"Modelica://Modelica.Fluid.Dissipation.HeatTransfer.HelicalPipe.kc_laminar_KC\"> kc_laminar_KC</a>.
      ...
      function kc_overall
        ...
        //input records
        input Dissipation.HeatTransfer.HelicalPipe.kc_overall_IN_con IN_con
          "Input record for function kc_overall" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.HeatTransfer.HelicalPipe.kc_overall_IN_var IN_var
          "Input record for function kc_overall" 
          annotation (Dialog(group="Variable inputs"));
      ...
      algorithm
        ...
        kc := Dissipation.HeatTransfer.HelicalPipe.kc_overall_KC(IN_con, IN_var);
        Nu := kc*IN_con.d_hyd/max(MIN, IN_var.lambda);
      annotation (Documentation(info="<html>
<p>
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2);
      ...
      algorithm
        kc := SMOOTH(
                Re_crit, 
                turbulent, 
                Re)*kc_laminar_KC(IN_con, IN_var) + SMOOTH(
                turbulent, 
                Re_crit, 
                Re)*kc_turbulent_KC(IN_con, IN_var);
      annotation (Documentation(info="<html>
<p>
Calculation of the mean convective heat transfer coefficient <b> kc </b> of a helical pipe in a hydrodynamically developed laminar and turbulent flow regime.
<a href=\"modelica://Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.HeatTransfer.HelicalPipe.kc_overall\">See more information</a> .
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2);
      ...
      record kc_overall_IN_con
        ...
        extends Dissipation.Utilities.Records.HeatTransfer.HelicalPipe;
...
<a href=\"Modelica://Modelica.Fluid.Dissipation.HeatTransfer.HelicalPipe.kc_overall_KC\"> kc_overall_KC</a>.
      ...
      function kc_turbulent
        ...
        //input records
        input Dissipation.HeatTransfer.HelicalPipe.kc_turbulent_IN_con IN_con
          "Input record for function  kc_turbulent" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.HeatTransfer.HelicalPipe.kc_turbulent_IN_var IN_var
          "Input record for function  kc_turbulent" 
          annotation (Dialog(group="Variable inputs"));
      ...
      algorithm
        ...
        kc := Dissipation.HeatTransfer.HelicalPipe.kc_turbulent_KC(IN_con, IN_var);
        Nu := kc*IN_con.d_hyd/max(MIN, IN_var.lambda);
...
<a href=\"modelica://Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.HeatTransfer.HelicalPipe.kc_overall\">See more information</a>.</p>
    ...
    extends Modelica.Icons.VariantsPackage;
      ...
      function kc_laminar
        ...
        //icon
        extends Dissipation.Utilities.Icons.HeatTransfer.Plate1_d;

        //input records
        input Dissipation.HeatTransfer.Plate.kc_laminar_IN_con IN_con
          "Input record for function kc_laminar" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.HeatTransfer.Plate.kc_laminar_IN_var IN_var
          "Input record for function kc_laminar" 
          annotation (Dialog(group="Variable inputs"));
      ...
      algorithm
        ...
        kc := Dissipation.HeatTransfer.Plate.kc_laminar_KC(IN_con, IN_var);
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2);
      ...
      record kc_laminar_IN_con
        "Input record for function kc_laminar and kc_laminar_KC"
        extends Dissipation.HeatTransfer.Plate.kc_overall_IN_con;
...
<a href=\"modelica://Modelica.Fluid.Dissipation.HeatTransfer.Plate.kc_laminar_KC\">  kc_laminar_KC</a>.
      ...
      record kc_laminar_IN_var
        "Input record for function kc_laminar and kc_laminar_KC"
        extends Dissipation.HeatTransfer.Plate.kc_overall_IN_var;
...
<a href=\"modelica://Modelica.Fluid.Dissipation.HeatTransfer.Plate.kc_laminar_KC\">  kc_laminar_KC</a>.
      ...
      function kc_overall
        ...
        //input records
        input Dissipation.HeatTransfer.Plate.kc_overall_IN_con IN_con
          "Input record for function kc_overall" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.HeatTransfer.Plate.kc_overall_IN_var IN_var
          "Input record for function kc_overall" 
          annotation (Dialog(group="Variable inputs"));
        //output variables
        output SI.CoefficientOfHeatTransfer kc
      ...
      algorithm
        Pr := IN_var.eta*IN_var.cp/max(MIN, IN_var.lambda);
        Re := max(1e-3, abs(IN_var.rho*IN_var.velocity*IN_con.L/max(MIN, IN_var.eta)));
        kc := Dissipation.HeatTransfer.Plate.kc_overall_KC(IN_con, IN_var);
        Nu := kc*IN_con.L/max(MIN, IN_var.lambda);
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2);
      ...
      protected
        SI.CoefficientOfHeatTransfer kc_lam=
            kc_laminar_KC(                                                   IN_con, IN_var);
        SI.CoefficientOfHeatTransfer kc_turb=
            kc_turbulent_KC(                                                   IN_con, IN_var);
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2);
      ...
      record kc_overall_IN_con
        ...
        //plate variables
        extends Dissipation.Utilities.Records.HeatTransfer.Plate;
...
<a href=\"modelica://Modelica.Fluid.Dissipation.HeatTransfer.Plate.kc_overall_KC\"> kc_overall_KC</a>.
      ...
      function kc_turbulent
        ...
        //input records
        input Dissipation.HeatTransfer.Plate.kc_turbulent_IN_con IN_con
          "Input record for function kc_turbulent" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.HeatTransfer.Plate.kc_turbulent_IN_var IN_var
          "Input record for function kc_turbulent" 
          annotation (Dialog(group="Variable inputs"));
      ...
      algorithm
        Pr := abs(IN_var.eta*IN_var.cp/max(MIN, IN_var.lambda));
        Re := max(1e-3, abs(IN_var.rho*IN_var.velocity*IN_con.L/max(MIN, IN_var.eta)));
        kc := Dissipation.HeatTransfer.Plate.kc_turbulent_KC(IN_con, IN_var);
        Nu := kc*IN_con.L/max(MIN, IN_var.lambda);
...
Calculation of the mean convective heat transfer coefficient <b> kc </b> for an laminar and turbulent fluid flow over an even surface. <a href=\"modelica://Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.HeatTransfer.Plate.kc_overall\">See more information</a>.
    ...
    extends Modelica.Icons.VariantsPackage;
      ...
      function kc_laminar
        ...
        //input records
        input Dissipation.HeatTransfer.StraightPipe.kc_laminar_IN_con IN_con
          "Input record for function kc_laminar" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.HeatTransfer.StraightPipe.kc_laminar_IN_var IN_var
          "Input record for function kc_laminar" 
          annotation (Dialog(group="Variable inputs"));
      ...
      algorithm
        ...
        kc := Dissipation.HeatTransfer.StraightPipe.kc_laminar_KC(IN_con, IN_var);
        Nu := kc*IN_con.d_hyd/max(MIN, IN_var.lambda);
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2);
      ...
      protected
        type TYP = 
            Dissipation.Utilities.Types.HeatTransferBoundary;
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2);
      ...
      record kc_laminar_IN_con
        ...
        extends Utilities.Records.HeatTransfer.StraightPipe;
          ...
          //choices
        Dissipation.Utilities.Types.HeatTransferBoundary target=Dissipation.Utilities.Types.HeatTransferBoundary.UWTuDFF
...
<a href=\"modelica://Modelica.Fluid.Dissipation.HeatTransfer.StraightPipe.kc_laminar_KC\"> kc_laminar_KC</a>.
      ...
      record kc_laminar_IN_var
        "Input record for function kc_laminar and kc_laminar_KC"
        extends Dissipation.HeatTransfer.StraightPipe.kc_overall_IN_var;
...
<a href=\"modelica://Modelica.Fluid.Dissipation.HeatTransfer.StraightPipe.kc_laminar_KC\"> kc_laminar_KC</a>.
      ...
      function kc_overall
        ...
        //input records
        input Dissipation.HeatTransfer.StraightPipe.kc_overall_IN_con IN_con
          "Input record for function kc_overall" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.HeatTransfer.StraightPipe.kc_overall_IN_var IN_var
          "Input record for function kc_overall" 
          annotation (Dialog(group="Variable inputs"));
      ...
      protected
        type TYP = Dissipation.Utilities.Types.Roughness;
      ...
      algorithm
        Pr := abs(IN_var.eta*IN_var.cp/max(MIN, IN_var.lambda));
        Re := max(1e-3, IN_var.rho*velocity*IN_con.d_hyd/max(MIN, IN_var.eta));
        kc := Dissipation.HeatTransfer.StraightPipe.kc_overall_KC(IN_con, IN_var);
        Nu := kc*IN_con.d_hyd/max(MIN, IN_var.lambda);
...
<a href=\"modelica://Modelica.Fluid.Dissipation.HeatTransfer.StraightPipe.kc_overall_KC\"> kc_overall_KC</a>.
      ...
      function kc_turbulent
        ...
        //input records
        input Dissipation.HeatTransfer.StraightPipe.kc_turbulent_IN_con IN_con
          "Input record for function kc_turbulent" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.HeatTransfer.StraightPipe.kc_turbulent_IN_var IN_var
          "Input record for function kc_turbulent" 
          annotation (Dialog(group="Variable inputs"));
      ...
      algorithm
        Pr := abs(IN_var.eta*IN_var.cp/max(MIN, IN_var.lambda));
        Re := max(1e-3, IN_var.rho*velocity*IN_con.d_hyd/max(MIN, IN_var.eta));
        kc := Dissipation.HeatTransfer.StraightPipe.kc_turbulent_KC(IN_con, IN_var);
        Nu := kc*IN_con.d_hyd/max(MIN, IN_var.lambda);
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2);
      ...
      record kc_turbulent_IN_con
        ...
        Dissipation.Utilities.Types.Roughness roughness=Dissipation.Utilities.Types.Roughness.Considered
...
<a href=\"modelica://Modelica.Fluid.Dissipation.HeatTransfer.StraightPipe.kc_turbulent_KC\">kc_turbulent_KC</a>.
      ...
      function kc_twoPhaseOverall_KC
        ...
        //input records
        input
          Dissipation.HeatTransfer.StraightPipe.kc_twoPhaseOverall_KC_IN_con
          IN_con annotation (Dialog(group="Constant inputs"));
        input
          Dissipation.HeatTransfer.StraightPipe.kc_twoPhaseOverall_KC_IN_var
      ...
      protected
        ...
        //Documentation
      algorithm
        kc := if IN_con.target == Modelica.Fluid.Dissipation.Utilities.Types.TwoPhaseHeatTransferTarget.BoilHor
           then
          Dissipation.Utilities.Functions.HeatTransfer.TwoPhase.kc_twoPhase_boilingHorizontal_KC(
          IN_con, IN_var) else if IN_con.target == Modelica.Fluid.Dissipation.Utilities.Types.TwoPhaseHeatTransferTarget.BoilVer
           then
          Dissipation.Utilities.Functions.HeatTransfer.TwoPhase.kc_twoPhase_boilingVertical_KC(
          IN_con, IN_var) else if IN_con.target == Modelica.Fluid.Dissipation.Utilities.Types.TwoPhaseHeatTransferTarget.CondHor
           then
          Dissipation.Utilities.Functions.HeatTransfer.TwoPhase.kc_twoPhase_condensationHorizontal_KC(
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2);
      ...
      record kc_twoPhaseOverall_KC_IN_con
        ...
        extends
          Dissipation.Utilities.Records.HeatTransfer.TwoPhaseFlowHT_IN_con;
...
This record is used as <b> input record </b> for the heat transfer function <a href=\"modelica://Modelica.Fluid.Dissipation.HeatTransfer.StraightPipe.kc_twoPhaseOverall_KC\"> kc_twoPhaseOverall_KC</a>.
      ...
      record kc_twoPhaseOverall_KC_IN_var
        "Input record for function kc_twoPhaseOverall_KC"
        extends
          Dissipation.Utilities.Records.HeatTransfer.TwoPhaseFlowHT_IN_var;
  ...
  extends Modelica.Icons.VariantsPackage;
    ...
    extends Modelica.Icons.VariantsPackage;
      ...
      function dp_curvedOverall_DP
        ...
        import FD = Dissipation.PressureLoss.Bend;
        import SMOOTH = Dissipation.Utilities.Functions.General.Stepsmoother;

        //input records
        input Dissipation.PressureLoss.Bend.dp_curvedOverall_IN_con IN_con
          "Input record for function dp_curvedOverall_DP" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.PressureLoss.Bend.dp_curvedOverall_IN_var IN_var
          "Input record for function dp_curvedOverall_DP" 
          annotation (Dialog(group="Variable inputs"));
      ...
      algorithm
        DP := zeta_TOT*(IN_var.rho/2)*
          Dissipation.Utilities.Functions.General.SmoothPower(
                m_flow, 
                m_flow_smooth, 
...
"),       smoothOrder(__Dymola_normallyConstant=IN_con) = 2,
      ...
      record dp_curvedOverall_IN_con
        ...
        //bend variables
        extends Dissipation.Utilities.Records.PressureLoss.Bend;
...
and <a href=\"modelica://Modelica.Fluid.Dissipation.PressureLoss.Bend.dp_curvedOverall_MFLOW\"> dp_curvedOverall_MFLOW </a>.
      ...
      record dp_curvedOverall_IN_var
        ...
        //fluid property variables
        extends Dissipation.Utilities.Records.General.PressureLoss;
...
and <a href=\"modelica://Modelica.Fluid.Dissipation.PressureLoss.Bend.dp_curvedOverall_MFLOW\"> dp_curvedOverall_MFLOW </a>.
      ...
      function dp_edgedOverall_DP
        ...
        //icon
        extends Dissipation.Utilities.Icons.PressureLoss.BendEdged_d;

        //input records
        input Dissipation.PressureLoss.Bend.dp_edgedOverall_IN_con IN_con
          "Input record for function dp_edgedOverall_DP" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.PressureLoss.Bend.dp_edgedOverall_IN_var IN_var
          "Input record for function dp_edgedOverall_DP" 
          annotation (Dialog(group="Variable inputs"));
        input SI.MassFlowRate m_flow "Mass flow rate" 
          annotation (Dialog(group="Input"));
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2,
      ...
      record dp_edgedOverall_IN_con
        ...
        extends Dissipation.Utilities.Records.PressureLoss.EdgedBend;
...
<a href=\"modelica://Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.PressureLoss.Bend.dp_edgedOverall\">See more information</a> .</p>
    ...
    extends Modelica.Icons.VariantsPackage;
      ...
      function dp_internalFlowOverall_DP
        ...
        import FD = Dissipation.PressureLoss.Channel;
        import SMOOTH = Dissipation.Utilities.Functions.General.Stepsmoother;

        //icon
        extends Dissipation.Utilities.Icons.PressureLoss.Channel_d;

        //input records
        input Dissipation.PressureLoss.Channel.dp_internalFlowOverall_IN_con
          IN_con "Input record for function dp_internalFlowOverall_DP" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.PressureLoss.Channel.dp_internalFlowOverall_IN_var
      ...
      protected
        type TYP = 
            Dissipation.Utilities.Types.GeometryOfInternalFlow;
      ...
      protected
        Dissipation.PressureLoss.StraightPipe.dp_overall_IN_con IN_2_con(
          final roughness=IN_con.roughness,
          final d_hyd=d_hyd,
          final K=IN_con.K,
          final L=IN_con.L) "Input record for turbulent regime" 
          annotation (Placement(transformation(extent={{-100,20},{-80,40}})));
        Dissipation.PressureLoss.StraightPipe.dp_overall_IN_var IN_2_var(final
            eta=IN_var.eta, final rho=IN_var.rho)
      ...
      algorithm
        DP := SMOOTH(
                ...
                Re_lam_max, 
                Re_lam_min, 
                Re)*StraightPipe.dp_turbulent_DP(
                IN_2_con, 
                IN_2_var, 
                m_flow_turb);
      annotation(Documentation(info="<html>
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2,
      ...
      protected
        type TYP1 = 
            Dissipation.Utilities.Types.GeometryOfInternalFlow;
        type TYP2 = Dissipation.Utilities.Types.Roughness;
...
Generally this function is numerically best used for the <b> compressible case </b> if the pressure loss (dp) is known (out of pressures as state variable) and the mass flow rate (M_FLOW) has to be calculated. On the other hand the function <a href=\"modelica://Modelica.Fluid.Dissipation.PressureLoss.Channel.dp_internalFlowOverall_DP\">dp_internalFlowOverall</a> is numerically best used for the <b> incompressible case </b>, where the mass flow rate (m_flow) is known (as state variable) in the used model and the corresponding pressure loss (DP) has to be calculated. <a href=\"modelica://Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.PressureLoss.Channel.dp_internalFlowOverall\">See more information</a>.
      ...
      record dp_internalFlowOverall_IN_con
        ...
        extends Dissipation.Utilities.Records.PressureLoss.Geometry;
...
<a href=\"modelica://Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.PressureLoss.Channel.dp_internalFlowOverall\">See more information</a>.
    ...
    extends Modelica.Icons.VariantsPackage;
      ...
      function dp_idealGas_DP
        ...
        import FD = Dissipation.PressureLoss.General;
        //input records
        input Dissipation.PressureLoss.General.dp_idealGas_IN_con IN_con
          "Input record for function dp_idealGas_DP" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.PressureLoss.General.dp_idealGas_IN_var IN_var
          "Input record for function dp_idealGas_DP" 
          annotation (Dialog(group="Variable inputs"));
        input SI.MassFlowRate m_flow "Mass flow rate" 
          annotation (Dialog(group="Input"));
    ...
    In Proceedings of European Simulation MultiConference, Praque, 1995.</dd>
      ...
      algorithm
        M_FLOW := (IN_con.R_s/Km_internal)^(1/IN_con.exp)*(rho_internal)^(1/
          IN_con.exp)*Utilities.Functions.General.SmoothPower(
                dp, 
                IN_con.dp_smooth, 
                1/IN_con.exp);
      annotation (Documentation(info="<html>
...
<dt>Elmquist, H., M.Otter and S.E. Cellier:</dt>
    ...
    In Proceedings of European Simulation MultiConference, Praque, 1995.</dd>
      ...
      record dp_idealGas_IN_con
        ...
        //generic variables
        extends Dissipation.Utilities.Records.General.IdealGas_con;
...
<a href=\"modelica://Modelica.Fluid.Dissipation.PressureLoss.General.dp_idealGas_MFLOW\"> dp_idealGas_MFLOW </a>.
      ...
      record dp_idealGas_IN_var
        ...
        //generic variables
        extends Dissipation.Utilities.Records.General.IdealGas_var;
...
<a href=\"modelica://Modelica.Fluid.Dissipation.PressureLoss.General.dp_idealGas_MFLOW\"> dp_idealGas_MFLOW</a>.
      ...
      function dp_nominalDensityViscosity_DP
        ...
        //input records
        input
          Dissipation.PressureLoss.General.dp_nominalDensityViscosity_IN_con
          IN_con "Input record for function dp_nominalDensityViscosity_DP" 
          annotation (Dialog(group="Constant inputs"));
        input
          Dissipation.PressureLoss.General.dp_nominalDensityViscosity_IN_var
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2,
      ...
      record dp_nominalDensityViscosity_IN_con
        ...
        //generic variables
        extends Dissipation.Utilities.Records.General.NominalDensityViscosity;
...
<a href=\"modelica://Modelica.Fluid.Dissipation.PressureLoss.General.dp_nominalDensityViscosity_MFLOW\"> dp_nominalDensityViscosity_MFLOW</a>.
      ...
      function dp_nominalPressureLossLawDensity_DP
        ...
        //input records
        input
          Dissipation.PressureLoss.General.dp_nominalPressureLossLawDensity_IN_con
          IN_con
          "Input record for function dp_nominalPressureLossLawDensity_DP" 
          annotation (Dialog(group="Constant inputs"));
        input
          Dissipation.PressureLoss.General.dp_nominalPressureLossLawDensity_IN_var
          IN_var
          "Input record for function dp_nominalPressureLossLawDensity_DP" 
          annotation (Dialog(group="Variable inputs"));
        input SI.MassFlowRate m_flow "Mass flow rate" 
...
<dt>Wischhusen, S.:</dt>
    ...
    PhD thesis, Technische Universität Hamburg-Harburg, 2005.</dd>
      ...
      record dp_nominalPressureLossLawDensity_IN_con
        ...
        //generic variables
        extends
          Dissipation.Utilities.Records.General.NominalPressureLossLawDensity_con;
...
<a href=\"modelica://Modelica.Fluid.Dissipation.PressureLoss.General.dp_nominalPressureLossLawDensity_MFLOW\"> dp_nominalPressureLosslawDensity_MFLOW</a>.
      ...
      record dp_nominalPressureLossLawDensity_IN_var
        ...
        //generic variables
        extends
          Dissipation.Utilities.Records.General.NominalPressureLossLawDensity_var;
...
<a href=\"modelica://Modelica.Fluid.Dissipation.PressureLoss.General.dp_nominalPressureLossLawDensity_MFLOW\"> dp_nominalPressureLosslawDensity_MFLOW</a>.
      ...
      function dp_pressureLossCoefficient_DP
        ...
        //input records
        input
          Dissipation.PressureLoss.General.dp_pressureLossCoefficient_IN_con
          IN_con "Input record for dp_pressureLossCoefficient_DP" 
          annotation (Dialog(group="Constant inputs"));
        input
          Dissipation.PressureLoss.General.dp_pressureLossCoefficient_IN_var
...
<a href=\"modelica://Modelica.Fluid.Dissipation.PressureLoss.General.dp_pressureLossCoefficient_MFLOW\"> dp_pressureLossCoefficient_MFLOW</a>.
      ...
      function dp_volumeFlowRate_DP
        ...
        //input records
        input Dissipation.PressureLoss.General.dp_volumeFlowRate_IN_con IN_con
          "Input record for function dp_volumeFlowRate_DP" 
          annotation (Dialog(group="Constant inputs"));

        input Dissipation.PressureLoss.General.dp_volumeFlowRate_IN_var IN_var
          "Input record for function dp_volumeFlowRate_DP" 
          annotation (Dialog(group="Variable inputs"));
        input SI.MassFlowRate m_flow "Mass flow rate" 
          annotation (Dialog(group="Input"));
      ...
      algorithm
        DP := a*Utilities.Functions.General.SmoothPower(
                V_flow, 
                V_flow_smooth, 
                2) + b*V_flow;
      annotation (Documentation(info="<html>
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2,
      ...
      record dp_volumeFlowRate_IN_con
        ...
        //generic variables
        extends Dissipation.Utilities.Records.General.QuadraticVFLOW;
 ...
 <a href=\"modelica://Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.PressureLoss.General.dp_volumeFlowRate\">See more information</a>.
    ...
    extends Modelica.Icons.VariantsPackage;
      ...
      function dp_suddenChange_DP
        ...
        import FD = Dissipation.PressureLoss.Orifice;

        //icon
        extends
          Dissipation.Utilities.Icons.PressureLoss.OrificeSuddenChangeSection_d;

        import SMOOTH = Dissipation.Utilities.Functions.General.Stepsmoother;

        //input records
        input Dissipation.PressureLoss.Orifice.dp_suddenChange_IN_con IN_con
          "Input record for function dp_suddenChange_DP" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.PressureLoss.Orifice.dp_suddenChange_IN_var IN_var
          "Input record for function dp_suddenChange_DP" 
          annotation (Dialog(group="Variable inputs"));
        input SI.MassFlowRate m_flow "Mass flow rate" 
          annotation (Dialog(group="Input"));
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2,
      ...
      record dp_suddenChange_IN_con
        ...
        //orifice variables
        extends Dissipation.Utilities.Records.PressureLoss.SuddenChange;
...
<a href=\"modelica://Modelica.Fluid.Dissipation.PressureLoss.Orifice.dp_suddenChange_MFLOW\"> dp_suddenChange_MFLOW</a>.
      ...
      function dp_thickEdgedOverall_DP
        ...
        //icon
        extends Dissipation.Utilities.Icons.PressureLoss.OrificeThickEdged_d;

        //input records
        input Dissipation.PressureLoss.Orifice.dp_thickEdgedOverall_IN_con
          IN_con "Input record for function dp_thickEdgedOverall_DP" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.PressureLoss.Orifice.dp_thickEdgedOverall_IN_var
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2,
      ...
      record dp_thickEdgedOverall_IN_con
        ...
        //orifice variables
        extends Dissipation.Utilities.Records.PressureLoss.Orifice;
...
<a href=\"modelica://Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.PressureLoss.Orifice.dp_thickEdgedOverall\">See more information</a>.
    ...
    extends Modelica.Icons.VariantsPackage;
      ...
      function dp_laminar_DP
        ...
        import FD = Dissipation.PressureLoss.StraightPipe;

        //icon
        extends Dissipation.Utilities.Icons.PressureLoss.StraightPipe_d;

        //input records
        input Dissipation.PressureLoss.StraightPipe.dp_laminar_IN_con IN_con
          "Input record for function dp_laminar_DP" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.PressureLoss.StraightPipe.dp_laminar_IN_var IN_var
          "Input record for function dp_laminar_DP" 
          annotation (Dialog(group="Variable inputs"));
        input SI.MassFlowRate m_flow "Mass flow rate" 
          annotation (Dialog(group="Input"));
...
<a href=\"modelica://Modelica.Fluid.Dissipation.PressureLoss.StraightPipe.dp_laminar_MFLOW\"> dp_laminar_MFLOW</a>.
      ...
      record dp_laminar_IN_var
        ...
        extends Dissipation.PressureLoss.StraightPipe.dp_overall_IN_var;
...
<a href=\"modelica://Modelica.Fluid.Dissipation.PressureLoss.StraightPipe.dp_laminar_MFLOW\"> dp_laminar_MFLOW</a>.
      ...
      function dp_overall_DP
        ...
        //input records
        input Dissipation.PressureLoss.StraightPipe.dp_overall_IN_con IN_con
          "Input record for function dp_overall_DP" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.PressureLoss.StraightPipe.dp_overall_IN_var IN_var
          "Input record for function dp_overall_DP" 
          annotation (Dialog(group="Variable inputs"));
        input SI.MassFlowRate m_flow "Mass flow rate" 
          annotation (Dialog(group="Input"));
      ...
      protected
        ...
        SI.ReynoldsNumber Re=
            Utilities.Functions.General.ReynoldsNumber(
            A_cross,
            perimeter,
            IN_var.rho,
            IN_var.eta,
...
Generally this  function is numerically best used for the <b> incompressible case </b>, where the mass flow rate (m_flow) is known (as state variable) in the used model and the corresponding pressure loss (DP) has to be calculated. On the other hand the  function <a href=\"modelica://Modelica.Fluid.Dissipation.PressureLoss.StraightPipe.dp_overall_MFLOW\">dp_overall_MFLOW</a> is numerically best used for the <b> compressible case </b> if the pressure loss (dp) is known (out of pressures as state variable) and the mass flow rate (M_FLOW) has to be calculated.   <a href=\"modelica://Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.PressureLoss.StraightPipe.dp_overall\">See more information</a>.
      ...
      algorithm
        M_FLOW := SMOOTH(
                Re_lam_min, 
                Re_turb, 
                Re)*FD.dp_laminar_MFLOW(
                IN_con, 
                IN_var, 
                dp) + SMOOTH(
                Re_turb, 
                Re_lam_min, 
                Re)*FD.dp_turbulent_MFLOW(
                IN_con, 
                IN_var, 
                dp);
      annotation (Documentation(info="<html>
...
<a href=\"modelica://Modelica.Fluid.Dissipation.PressureLoss.StraightPipe.dp_overall_MFLOW\"> dp_overall_MFLOW</a>.
      ...
      function dp_turbulent_DP
        ...
        //input records
        input Dissipation.PressureLoss.StraightPipe.dp_turbulent_IN_con IN_con
          "Input record for function dp_turbulent_DP" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.PressureLoss.StraightPipe.dp_turbulent_IN_var IN_var
          "Input record for function dp_turbulent_DP" 
          annotation (Dialog(group="Variable inputs"));
        input SI.MassFlowRate m_flow "Mass flow rate" 
          annotation (Dialog(group="Input"));
      ...
      protected
        type TYP1 = Dissipation.Utilities.Types.Roughness;
        ...
        TYP.DarcyFrictionFactor lambda_FRI_calc=if Re < Re_lam_leave then 64/Re else 
            ...
            Utilities.Functions.General.CubicInterpolation_MFLOW(
            Re,
            Re_lam_leave,
            Re_turb_min,
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2,
      ...
      record dp_turbulent_IN_con
        ...
        Dissipation.Utilities.Types.Roughness roughness=Dissipation.Utilities.Types.Roughness.Neglected
          "Choice of considering surface roughness" 
...
<a href=\"modelica://Modelica.Fluid.Dissipation.PressureLoss.StraightPipe.dp_turbulent_MFLOW\"> dp_turbulent_MFLOW</a>.
      ...
      function dp_twoPhaseOverall_DP
        ...
        //input records
        input Dissipation.PressureLoss.StraightPipe.dp_twoPhaseOverall_IN_con
          IN_con "Input record for function dp_twoPhaseOverall_DP" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.PressureLoss.StraightPipe.dp_twoPhaseOverall_IN_var
      ...
      protected
        type TYP = 
            Dissipation.Utilities.Types.TwoPhaseFrictionalPressureLoss;
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2);
      ...
      record dp_twoPhaseOverall_IN_con
        ...
        Dissipation.Utilities.Types.TwoPhaseFrictionalPressureLoss
          ...
          annotation (Dialog(group="Choices"));
        Dissipation.Utilities.Types.Roughness voidFractionApproach=Dissipation.Utilities.Types.VoidFractionApproach.Homogeneous
        ...
        extends Dissipation.Utilities.Records.General.TwoPhaseFlow_con;
...
This record is used as <b> input record </b> for the pressure loss function <a href=\"modelica://Modelica.Fluid.Dissipation.PressureLoss.StraightPipe.dp_twoPhaseOverall_DP\"> dp_twoPhaseOverall_DP</a>.
      ...
      record dp_twoPhaseOverall_IN_var
        ...
        Real x_flow_sta=0 "Mass flow rate quality at start of length" 
          annotation (Dialog(group="Fluid properties"));
        extends Dissipation.Utilities.Records.General.TwoPhaseFlow_var(final
 ...
 <a href=\"modelica://Modelica.Fluid.Dissipation.Utilities.SharedDocumentation.PressureLoss.StraightPipe.dp_twoPhaseOverall\">See more information</a>.
    ...
    extends Modelica.Icons.VariantsPackage;
      ...
      function dp_severalGeometryOverall_DP
        ...
        import FD = Dissipation.PressureLoss.Valve;
        import SMOOTH = Dissipation.Utilities.Functions.General.Stepsmoother;
        import TYP = Dissipation.Utilities.Types;

        //icon
        extends Dissipation.Utilities.Icons.PressureLoss.Valve_d;

        //input records
        input Dissipation.PressureLoss.Valve.dp_severalGeometryOverall_IN_con
          IN_con "Input record for function dp_severalGeometryOverall_DP" 
          annotation (Dialog(group="Constant inputs"));
        input Dissipation.PressureLoss.Valve.dp_severalGeometryOverall_IN_var
      ...
      protected
        type TYP1 = 
            Dissipation.Utilities.Types.ValveCoefficient;
        type TYP2 = Dissipation.Utilities.Types.ValveGeometry;
...
"),                 smoothOrder(__Dymola_normallyConstant=IN_con) = 2,
      ...
      record dp_severalGeometryOverall_IN_con
        ...
        Dissipation.Utilities.Types.ValveGeometry geometry=Dissipation.Utilities.Types.ValveGeometry.Ball
          "Choice of geometry for valve" annotation (Dialog(group="Valve"));
        Dissipation.Utilities.Types.ValveCoefficient valveCoefficient=Modelica.Fluid.Dissipation.Utilities.Types.ValveCoefficient.AV
...
<p>
<table>
<tr><td><b> A_1       </b></td><td> small cross sectional area [m2],</td></tr>
<tr><td><b> A_2       </b></td><td> large cross sectional area [m2]</td></tr>
</table>
</p>
...
<ul>
 <li>
     <b> Laminar flow regime </b> is restricted to a Reynolds number <b> Re </b> &le; 2000 and calculated through:
     <pre>
     lambda_FRI = 64/Re
     </pre>
     <p>
...
<p>
Note that this pressure loss function shall not be used for the modelling outside of the laminar flow regime at <b> Re </b> &gt; 2000 even though it could be used for that.
</p>
<p>
If the whole flow
...
<b> Laminar regime </b> is calculated for <b> Re </b> &le; 2000 by the Hagen-Poiseuille law according to <i>[Idelchik 2006, p. 77, eq. 2-3]</i>
<pre>
    lambda_FRI = 64/Re
</pre>
      ...
      package PressureLoss "Package for utility pressure loss functions"
        ...
        package TwoPhase
          ...
          function dp_twoPhaseChisholm_DP
            ...
            //records
            input Dissipation.Utilities.Records.General.TwoPhaseFlow_con IN_con
              annotation (Dialog(group="Constant inputs"));
            input Dissipation.Utilities.Records.General.TwoPhaseFlow_var IN_var
              annotation (Dialog(group="Variable inputs"));
            input SI.MassFlowRate m_flow "Mass flow rate" 
              annotation (Dialog(group="Input"));
          ...
          protected
            ...
            Dissipation.PressureLoss.StraightPipe.dp_overall_IN_con IN_con_1ph(
            ...
            Dissipation.PressureLoss.StraightPipe.dp_overall_IN_var IN_var_1ph(
                final eta=IN_var.eta_l, final rho=IN_var.rho_l);

          algorithm
            DP := Dissipation.PressureLoss.StraightPipe.dp_overall_DP(
                        IN_con_1ph, 
                        IN_var_1ph, 
                        m_flow)*(
              Dissipation.Utilities.Functions.PressureLoss.TwoPhase.TwoPhaseMultiplierChisholm(
                        IN_con, 
                        IN_var, 
                        m_flow));
          ...
          function dp_twoPhaseFriedel_DP
            ...
            import SMOOTH =
              Dissipation.Utilities.Functions.General.Stepsmoother;
            import SMOOTH2 =
              Dissipation.Utilities.Functions.General.SmoothPower;
          ...
          algorithm
            DP := SMOOTH2(
                        ...
                        1, 
                        0)*DP_liq*(
              Dissipation.Utilities.Functions.PressureLoss.TwoPhase.TwoPhaseMultiplierFriedel(
                        IN_con, 
                        IN_var, 
                        m_flow));
          ...
          function dp_twoPhaseGeodetic_DP
            ...
            input Dissipation.Utilities.Types.VoidFractionApproach
          ...
          function dp_twoPhaseMomentum_DP
            ...
            import PI = Modelica.Constants.pi;
            import MIN = Modelica.Constants.eps;
            import SMOOTH = Dissipation.Utilities.Functions.General.SmoothPower;

            //choices
            input Dissipation.Utilities.Types.Roughness voidFractionApproach=
...
For y > 10 and higher values the relative deviation is smaller 2%.
  ...
  Real wPlusOneTimesExpW;*/
        ...
        algorithm
          w := if y > 0.1 then Dissipation.Utilities.Functions.General.LambertW(
    ...
    extends Modelica.Icons.Package;
      package General
        ...
        record NominalPressureLossLawDensity_con
          ...
          //NominalMassFlowRate
          Dissipation.Utilities.Types.MassOrVolumeFlowRate target=Dissipation.Utilities.Types.MassOrVolumeFlowRate.MassFlowRate
      ...
      package HeatTransfer
        ...
        record EvenGap "Input for even gap"
          ...
          //choices
          Dissipation.Utilities.Types.kc_evenGap target=Dissipation.Utilities.Types.kc_evenGap.DevBoth
        ...
        record General "Input for generic correlation"
          ...
          //choices
          Dissipation.Utilities.Types.kc_general target=Dissipation.Utilities.Types.kc_general.Finest
        ...
        record TwoPhaseFlowHT_IN_con
          ...
          //choices
          Dissipation.Utilities.Types.TwoPhaseHeatTransferTarget target=
      ...
      package PressureLoss
        ...
        record Geometry "Input for several geometries of internal flow"
          ...
          Dissipation.Utilities.Types.GeometryOfInternalFlow geometry=Modelica.Fluid.Dissipation.Utilities.Types.GeometryOfInternalFlow.Circular
        ...
        record PressureLossInput "Input for pressure loss calculation"
          ...
          //target variables
          Dissipation.Utilities.Types.PressureLossTarget target=Dissipation.Utilities.Types.PressureLossTarget.PressureLoss
