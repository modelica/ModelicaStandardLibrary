...
<li><a href=\"modelica://Modelica.Fluid.Examples.IncompressibleFluidNetwork\">Examples.IncompressibleFluidNetwork</a>.</li>
  ...
  model PipeOnePhaseHT
    "Dynamic pipe model for heat transfer applications without phase change"
...
<p>The intended use is as pipes in one-phase heat exchangers.</p>
  ...
  model PipeTwoPhaseHT
    "Dynamic pipe model for heat transfer applications where phase change can occur"
    import Modelica.Fluid.Types;
    import Modelica.Fluid.Types.Dynamics;
    import Modelica.Media.Interfaces.Choices.IndependentVariables;
