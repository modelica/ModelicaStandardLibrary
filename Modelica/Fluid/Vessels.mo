...
Limitation to bottom ports only, added inlet and outlet loss factors.</li>
  ...
  package BaseClasses
    ...
    protected
        ...
        Modelica.Blocks.Interfaces.RealInput portsData_diameter_internal[if use_portsData then nPorts else 0] = portsData.diameter if use_portsData and nPorts > 0;
        Modelica.Blocks.Interfaces.RealInput portsData_height_internal[if use_portsData then nPorts else 0] = portsData.height if use_portsData and nPorts > 0;
        Modelica.Blocks.Interfaces.RealInput portsData_zeta_in_internal[if use_portsData then nPorts else 0] = portsData.zeta_in if use_portsData and nPorts > 0;
        Modelica.Blocks.Interfaces.RealInput portsData_zeta_out_internal[if use_portsData then nPorts else 0] = portsData.zeta_out if use_portsData and nPorts > 0;
