...
<p>
Educational example of a magnetic circuit containing a toroidal iron core and an airgap:
</p>
<p>
...
Due to Faraday's law, the time derivative of flux causes an induced voltage both in the exciting coil (in positive direction) and in the measuring coil (in negatve direction). 
