...
model CompareModels
  "Compare non-hysteretic model and Tellinen/Everett"
  extends Modelica.Icons.Example;
  parameter Modelica.Units.SI.Current I=1 "Excitation peak current";
  Modelica.Units.SI.MagneticFieldStrength H1=coreNon_Hys.H
    "Field Strength in non-hysteretic core";
  Modelica.Units.SI.MagneticFluxDensity B1=coreNon_Hys.B
    "Flux Density in non-hysteretic core";
  Modelica.Units.SI.MagneticPolarization J1=B1 - mu_0*H1
    "Magnetic polarisation in non-hysteretic core";
  Modelica.Units.SI.MagneticFieldStrength H2=coreEverett.H
    "Field Strength in hysteretic core = H1";
  Modelica.Units.SI.MagneticFluxDensity B2=coreEverett.B
    "Flux Density in hysteretic core";
  Modelica.Units.SI.MagneticPolarization J2=B2 - mu_0*H2
    "Magnetic polarisation in hysteretic core";
  ...
  FluxTubes.Basic.ElectroMagneticConverter excitingCoil1(N=700) annotation (
      Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={20,50})));
  FluxTubes.Basic.ElectroMagneticConverter excitingCoil2(N=700) annotation (
      Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={20,-50})));
  FluxTubes.Shapes.FixedShape.GenericFluxTube coreNon_Hys(
    ...
    materialSSEE=
        Modelica.Magnetic.FluxTubes.Material.SoftMagnetic.SSEE.M330_50A(),
    area=0.000112,
    l=0.94) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={40,50})));
  FluxTubes.Shapes.HysteresisAndMagnets.GenericHystTellinenEverett coreEverett(
    mat=FluxTubes.Material.HysteresisEverettParameter.M330_50A(),
    l=0.94,
    A=0.000112,
    includeEddyCurrents=false,
    H(fixed=false),
    MagRel(fixed=true)) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={40,-50})));
  FluxTubes.Basic.Ground groundM1
    annotation (Placement(transformation(extent={{30,10},{50,30}})));
  FluxTubes.Basic.Ground groundM2
