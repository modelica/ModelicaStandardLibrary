...
",                    textStyle={TextStyle.Bold})}));
      ...
      equation
        ...
        connect(rotorAngleM.plug_p, smpmM.plug_sp) annotation (Line(points={{24,
                -10},{15,-10},{15,-10},{6,-10}}, color={0,0,255}));
        connect(rotorAngleM.flange, smpmM.flange) annotation (Line(points={{20,
                -20},{10,-20},{10,-20}}, color={0,0,0}));
...
"),           Rectangle(
      ...
      model SMR_Inverter
        ...
        Modelica.Magnetic.FundamentalWave.BasicMachines.SynchronousInductionMachines.SM_ReluctanceRotor
          ...
          Rrq=smrData.Rrq,
          TrRef=smrData.TrRef,
          alpha20r(displayUnit="1/K") = smrData.alpha20r) annotation (Placement(
              transformation(extent={{-10,-30},{10,-10}}, rotation=0)));
...
<a href=\"modelica://Modelica.Magnetic.FundamentalWave.BasicMachines.SynchronousInductionMachines\">SynchronousInductionMachines</a>
    ...
    package SynchronousInductionMachines "Synchronous machines"
      ...
      model SM_PermanentMagnet
        ...
        extends
          Modelica.Magnetic.FundamentalWave.Interfaces.PartialBasicNewInductionMachine(
          is(start=zeros(m)),
          Rs(start=0.03),
      ...
      public
        ...
        Modelica.Magnetic.FundamentalWave.Sources.ConstantMagneticPotentialDifference
          ...
          "Magnetic potential difference of permanent magnet" annotation (
            Placement(transformation(
              origin={-10,-40},
              extent={{-10,-10},{10,10}},
              rotation=270)));
        Modelica.Thermal.HeatTransfer.Sensors.ConditionalFixedHeatFlowSensor
          ...
          annotation (Placement(transformation(
              ...
              rotation=270,
              origin={40,-50})));
        Electrical.Machines.Losses.InductionMachines.PermanentMagnetLosses
      ...
      equation
        ...
        connect(heatFlowSensorDamperCage.port_b, internalThermalPort.heatPortRotorWinding)
          annotation (Line(
            ...
            color={191,0,0},
            smooth=Smooth.None));
        connect(stator.plug_n, permanentMagnetLosses.plug_p) annotation (Line(
      ...
      public
        ...
        Modelica.Thermal.HeatTransfer.Sensors.ConditionalFixedHeatFlowSensor
          ...
          annotation (Placement(transformation(
              ...
              origin={40,-50})));
      equation
        connect(short.port_n, rotorCage.port_n) annotation (Line(points={{10,-50},
                {10,-50},{20,-50}}, color={255,128,0}));
        connect(excitation.port_n, short.port_n) annotation (Line(points={{-10,
                -50},{-10,-50},{10,-50}}, color={255,128,0}));
        connect(excitation.port_n, rotorCage.port_n) annotation (Line(points={{
                -10,-50},{-10,-50},{20,-50}}, color={255,128,0}));
...
<a href=\"modelica://Modelica.Magnetic.FundamentalWave.BasicMachines.Components.SaliencyCageWinding\">SaliencyCageWinding</a>
      ...
      model SymmetricMultiPhaseCageWinding "Symmetrical rotor cage"
        ...
        Modelica.Magnetic.FundamentalWave.Components.MultiPhaseElectroMagneticConverter
          ...
          final orientation=
              Modelica.Electrical.MultiPhase.Functions.symmetricOrientation(
              m)) "Symmetric winding" annotation (Placement(transformation(
              origin={0,-10},
              extent={{-10,-10},{10,10}},
              rotation=90)));
...
<a href=\"modelica://Modelica.Magnetic.FundamentalWave.Interfaces.PartialTwoPort\">PartialTwoPort</a>
  ...
  */
      Electrical.Machines.Losses.InductionMachines.StrayLoad
                                         strayLoad(
