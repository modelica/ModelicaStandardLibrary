...
Default machine parameters are used.
      ...
      model AIMC_Conveyor "Asynchronous induction machine with squirrel cage and inverter driving a conveyor"
        ...
        Electrical.Machines.Sensors.CurrentQuasiRMSSensor currentQuasiRMSSensor annotation (Placement(transformation(extent={{20,100},{40,80}},  rotation=0)));
...
<p>Default machine parameters are used</p>
      ...
      model SMEE_DOL "Test example: ElectricalExcitedSynchronousInductionMachine starting direct on line"
        ...
        Electrical.Machines.Sensors.RotorDisplacementAngle rotorDisplacementAngle(p=smee.p, m=m) annotation (Placement(transformation(
              origin={20,-40},
              extent={{-10,10},{10,-10}},
              rotation=270)));
        ...
        Electrical.MultiPhase.Sensors.PowerSensor pSensor(m=m) annotation (Placement(transformation(
              origin={40,30},
              extent={{-10,-10},{10,10}},
              rotation=270)));
        ...
        Electrical.Analog.Sources.RampVoltage rampVoltage(
          ...
          startTime=0.5) annotation (Placement(transformation(
              ...
              extent={{10,-10},{-10,10}},
              rotation=90)));
        Electrical.Machines.Utilities.TerminalBox terminalBox(terminalConnection="Y", m=m)
      ...
      equation
        ...
        connect(booleanReplicator.y, idealCloser.control)
          annotation (Line(points={{1,10},{10,10},{10,43}},
                                                       color={255,0,255}));
        ...
        connect(idealCloser.plug_n, pSensor.pc) annotation (Line(points={{20,50},{40,50},{40,40}}, color={0,0,255}));
        connect(pSensor.nv, terminalBox.plug_sn) annotation (Line(points={{30,30},{20,30},{20,-20},{-16,-20},{-16,-30}}, color={0,0,255}));
        connect(pSensor.nc, iSensor.plug_p) annotation (Line(points={{40,20},{40,10}}, color={0,0,255}));
        connect(pSensor.pv, pSensor.pc) annotation (Line(points={{50,30},{50,40},{40,40}}, color={0,0,255}));
        annotation (experiment(
            StopTime=3,
            Interval=0.0001,
            Tolerance=1e-006),                                                Documentation(info="<html>
...
The permanent magnet is modeled by a magnetic potential difference. The internal reluctance of the permanent magnet is not taken into account. The internal reluctance needs to be modeled outside the permanent magnet model, e.g., by the total machine reluctance considered in the air gap model.
      ...
      equation
        ...
        connect(resistor.plug_n, starAuxiliary.plug_p) annotation (Line(
            ...
            color={0,0,255}));
        annotation (defaultComponentName="cage",
          obsolete="Wrong structure of multi phase cage, see #1536",
          Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},
                  {100,100}}), graphics={Ellipse(
                      extent={{-80,80},{80,-80}},
                      lineColor={0,0,0},
...
<a href=\"modelica://Modelica.Magnetic.FundamentalWave.BasicMachines.Components.RotorSaliencyAirGap\">RotorSaliencyAirGap</a>
      ...
      equation
        ...
        connect(resistor.heatPort, thermalCollector.port_a) annotation (Line(
            ...
            color={191,0,0}));
        annotation (defaultComponentName="cage",
          obsolete="Wrong structure of saliency cage, see #1536",
          Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,
