      ...
      equation
        ...
        connect(electroMagneticConverter.port_n, port_n) annotation (Line(
              points={{10,0},{100,0}}, color={255,
                128,0}));
        connect(ground.p, star.pin_n) annotation (Line(points={{80,-20},{76,-20},{70,-20}},
                           color={0,0,255}));
        ...
        connect(multiStar.starpoints, star.plug_p)
          annotation (Line(points={{40,-20},{50,-20},{50,-20}}, color={0,0,255}));
        connect(multiStar.plug_p, resistor.plug_n) annotation (Line(points={{20,-20},{
                20,-20},{20,-60},{-20,-60}}, color={0,0,255}));
        annotation (
          Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},
                  {100,100}}), graphics={
              Ellipse(
...
<a href=\"modelica://Modelica.Magnetic.FundamentalWave.BasicMachines.Components.RotorSaliencyAirGap\">RotorSaliencyAirGap</a>
      ...
      equation
        ...
        connect(electroMagneticConverter.plug_n, resistor.plug_n) annotation (
            Line(
            points={{10,-20},{20,-20},{20,-60},{-20,-60}},
            color={0,0,255}));
