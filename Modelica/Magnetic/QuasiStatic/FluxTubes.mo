...
<p>This model investigates a magnetic circuit consisting of four different cuboid sections. The circuit is operated at 50Hz and variable magnetic potential difference.</p>
    ...
    extends Modelica.Icons.ExamplesPackage;
      ...
      connect(referenceSensor.port, hollowCylinderAxialFlux1.port_p)
        ...
        Documentation(info="<html>
<p>Test of cylindrical components with leakage and sensors.</p>
</html>"));
      end CylinderLeakage;
    ...
    equation
      ...
      annotation (Icon(coordinateSystem(
          ...
          Text(
            ...
            lineColor={0,0,255})}), Documentation(info="<html>
<p>
Please refer to the description of the sub-package <a href=\"modelica://Modelica.Magnetic.FluxTubes.Shapes.FixedShape\">Shapes.FixedShape</a> for utilization of this partial model.
</p>
</html>"),
        Diagram(coordinateSystem(preserveAspectRatio=false)));
    ...
    equation
      ...
      annotation (Icon(coordinateSystem(
          ...
          Text(
            ...
            lineColor={0,0,255})}), Documentation(info="<html>
<p>
Please refer to the description of the sub-package <a href=\"modelica://Modelica.Magnetic.FluxTubes.Shapes.Leakage\">Shapes.Leakage</a> for utilization of this partial model.
</p>
</html>"));
    end PartialLeakage;
...
<img src=\"modelica://Modelica/Resources/Images/Magnetic/QuasiStatic/FluxTubes/permeabilities-0.png\" alt=\"Permeabilities=0\">
    ...
    annotation (Documentation(info="<html>
<p>This package contains sensors to be used with transient flux tubes models in order to provide information for quasi static parameters.</p>
</html>"));
    end Transient;
    annotation (Documentation(info="<html>
<p>
