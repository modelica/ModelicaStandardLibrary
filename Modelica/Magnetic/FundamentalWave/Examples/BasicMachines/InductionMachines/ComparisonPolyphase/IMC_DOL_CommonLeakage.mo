...
model IMC_DOL_CommonLeakage
  ...
  Modelica.Electrical.Polyphase.Sensors.CurrentQuasiRMSSensor currentRMSsensor0(m=m)
    annotation (Placement(transformation(origin={-20,72},extent={{-10,-10},{10,
            10}})));
  Modelica.Electrical.Machines.Utilities.TerminalBox terminalBox0(m=m,
      terminalConnection="Y") annotation (Placement(transformation(extent={{0,54},{
            20,74}})));
  ...
  Modelica.Mechanics.Rotational.Sources.QuadraticSpeedDependentTorque
    ...
    useSupport=false) annotation (Placement(transformation(extent={{80,38},{60,58}})));
  parameter
  ...
  Electrical.Polyphase.Sensors.CurrentQuasiRMSSensor currentRMSsensorH(m=m)
    annotation (Placement(transformation(origin={-20,10}, extent={{-10,-10},{10,
            10}})));
  Electrical.Machines.Utilities.TerminalBox terminalBoxH(m=m,
  ...
  Electrical.Polyphase.Sensors.CurrentQuasiRMSSensor          currentRMSsensor1(m=m)
    annotation (Placement(transformation(origin={-20,-46},
                                                         extent={{-10,-10},{10,
            10}})));
  Electrical.Machines.Utilities.TerminalBox          terminalBox1(m=m,
...
equation
  ...
  connect(aimc0.flange,loadInertia0. flange_a)
    annotation (Line(points={{20,48},{30,48}}));
  connect(terminalBox0.plug_sn,aimc0. plug_sn)
    annotation (Line(points={{4,58},{4,58}},   color={0,0,255}));
  connect(terminalBox0.plug_sp,aimc0. plug_sp)
    annotation (Line(points={{16,58},{16,58}}, color={0,0,255}));
  ...
  connect(idealCloserM.plug_n, currentRMSsensorH.plug_p) annotation (Line(
        points={{-60,72},{-50,72},{-50,10},{-30,10}}, color={0,0,255}));
  ...
  connect(currentRMSsensorH.plug_n, terminalBoxH.plugSupply)
    annotation (Line(points={{-10,10},{10,10},{10,2}}, color={0,0,255}));
  ...
  connect(idealCloserM.plug_n,currentRMSsensor1. plug_p) annotation (Line(
      points={{-60,72},{-50,72},{-50,-46},{-30,-46}},
      color={0,0,255}));
