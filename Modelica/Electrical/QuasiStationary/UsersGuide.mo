...
<ul>
  ...
  <li>is present only once in a multi-phase connector;
      a multi-phase component has only one reference angle common to all phases.</li>
...
of single-phase and multi-phase
...
<li>Added active, reactive and apparent power and power factor in interface models, see ticket
    <a href=\"https://trac.modelica.org/Modelica/ticket/1405\">#1405</a></li>
<li>Added complex single-phase and multi-phase impedance and admittance models (ticket
