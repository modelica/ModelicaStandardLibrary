...
model TestLineZmatrix "Test model of LineZmatrix"
...
algorithm
  when initial() then
    (Rcomp,Xcomp) := Modelica.Electrical.Analog.Lines.Functions.LineZmatrix(
      n=g.n,
      x=g.x,
      y=g.y,
      r=g.r,
...
<pre><span style=\"font-family: Courier New; font-size: 9pt;\">*****              Using LineZmatrix, RESULTS in ohm/km              *****</span></pre>
