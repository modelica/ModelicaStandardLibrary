...
<table border=\"0\" cellspacing=\"0\" cellpadding=\"2\">
  <caption style=\"caption-side:bottom\"><strong>Fig. 1:</strong> Firing (<code>fire</code>) and inverse firing (<code>notFire</code>) signal of PWM control; <code>d</code> = duty cycle; <code>f</code> = switching frequency </caption>
  <tr>
    <td>
