...
package MultiPhase "Library for electrical components with 2, 3 or more phases"
  ...
  package Examples "Multiphase test examples"
    ...
    model TransformerYY "Test example with multiphase components"
      ...
      Ideal.IdealTransformer idealTransformer(m=m) annotation (Placement(
    ...
    equation
      ...
      connect(starT2.plug_p, idealTransformer.plug_n2) annotation (Line(points=
              {{-20,-52},{-20,-26},{-20,-26},{-20,0}}, color={0,0,255}));
...
Simulate for 1 second (2 periods) and compare voltages and currents of source, transformer and load.
    ...
    model TransformerYD "Test example with multiphase components"
      ...
      Modelica.Electrical.Analog.Basic.Ground groundS annotation (Placement(
            transformation(extent={{-100,-100},{-80,-80}}, rotation=0)));
      Ideal.IdealTransformer idealTransformer(m=m, n=fill(nT, m)) annotation (
...
Simulate for 1 second (2 periods) and compare voltages and currents of source, transformer and load.
    ...
    model Rectifier "Test example with multiphase components"
      ...
      Ideal.IdealDiode idealDiode1(m=m) annotation (Placement(transformation(
            origin={10,20},
            extent={{-10,-10},{10,10}},
            rotation=90)));
      Basic.Star star1(m=m) annotation (Placement(transformation(
            ...
            extent={{-10,-10},{10,10}},
            rotation=90)));
      Ideal.IdealDiode idealDiode2(m=m) annotation (Placement(transformation(
            origin={10,-20},
            extent={{-10,-10},{10,10}},
            rotation=90)));
    ...
    equation
      ...
      connect(idealDiode2.plug_p, star2.plug_p) annotation (Line(points={{10,-30},
              {10,-35},{10,-40},{10,-40}}, color={0,0,255}));
...
Contains m transformers (Modelica.Electrical.Analog.Basic.Transformer)
    ...
    model VariableResistor
      ...
      extends Modelica.Electrical.MultiPhase.Interfaces.ConditionalHeatPort(
          final mh=m, T=T_ref);
      Modelica.Blocks.Interfaces.RealInput R[m] annotation (Placement(
            transformation(
            origin={0,100},
            extent={{-10,-10},{10,10}},
            rotation=270)));
...
<b>Attention!!!</b><br>
  ...
  Otherwise depending on the surrounding circuit the probability of singularities is high.
    ...
    model VariableConductor
      ...
      extends Modelica.Electrical.MultiPhase.Interfaces.ConditionalHeatPort(
          final mh=m, T=T_ref);
      Modelica.Blocks.Interfaces.RealInput G[m] annotation (Placement(
            transformation(
            origin={0,100},
            extent={{-10,-10},{10,10}},
            rotation=270)));
...
<b>Attention!!!</b><br>
  ...
  Otherwise depending on the surrounding circuit the probability of singularities is high.
    ...
    model VariableCapacitor
      ...
      Modelica.Blocks.Interfaces.RealInput C[m] annotation (Placement(
            transformation(
            origin={0,100},
            extent={{-10,-10},{10,10}},
            rotation=270)));
...
Cmin is a parameter with default value Modelica.Constants.eps.
    ...
    model VariableInductor
      ...
      Modelica.Blocks.Interfaces.RealInput L[m] annotation (Placement(
            transformation(
            origin={0,100},
            extent={{-10,-10},{10,10}},
            rotation=270)));
...
<p>
  ...
  package Sensors "Multiphase potential, voltage and current Sensors"
    ...
    equation
      ...
      annotation (
        Icon(graphics={Line(points={{70,0},{100,0}}, color={0,0,255}),Line(
              points={{-70,0},{-90,0}}, color={0,0,0}),Text(
...
thus measuring the m currents <i>i[m]</i> flowing from the m pins of plug_p to the m pins of plug_n.
    ...
    equation
      ...
      connect(product.y, sum.u) annotation (Line(points={{-30,-51},{-30,-54.5},
              {-30,-54.5},{-30,-58}}, color={0,0,127}));
      connect(sum.y, power) annotation (Line(points={{-30,-81},{-30,-90},{-80,-90},
              {-80,-110}}, color={0,0,127}));
      annotation (
        Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{
                100,100}}), graphics={Line(points={{0,100},{0,70}}, color={0,0,
              255}),Line(points={{0,-70},{0,-100}}, color={0,0,255}),Line(
              points={{-80,-100},{-80,0}}, color={0,0,255}),Text(
                  extent={{150,120},{-150,160}},
                  textString="%name",
                  lineColor={0,0,255}),Text(
                  extent={{0,-80},{140,-120}},
                  lineColor={0,0,0},
                  textString="m=%m"),Ellipse(
                  extent={{-70,70},{70,-70}},
                  lineColor={0,0,0},
                  fillColor={255,255,255},
              ...
              color={0,0,0}),Polygon(
                  ...
                  extent={{-29,-11},{30,-70}},
                  lineColor={0,0,0},
                  textString="P"),Line(points={{-100,0},{100,0}}, color={0,0,
              255})}),
        Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},
                {100,100}}), graphics),
...
<p>
  ...
  package Sources "Multiphase voltage and current sources"
    ...
    equation
      ...
      annotation (
        Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{
                100,100}}), graphics={Line(points={{-90,0},{-50,0}}, color={0,0,
              255}),Line(points={{50,0},{90,0}}, color={0,0,255}),Ellipse(
                  extent={{-50,50},{50,-50}},
                  lineColor={0,0,255},
                  fillColor={255,255,255},
              ...
              color={0,0,255}),Text(
                  ...
                  textString="%name",
                  lineColor={0,0,255}),Text(extent={{-100,100},{-20,60}},
...
Contains m constant voltage sources (Modelica.Electrical.Analog.Sources.ConstantVoltage)
    ...
    model SineVoltage "Multiphase sine voltage source"
      ...
      parameter Modelica.SIunits.Angle phase[m]=-{(j - 1)/m*2*Modelica.Constants.pi
          for j in 1:m} "Phases of sine waves";
