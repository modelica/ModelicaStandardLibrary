...
<a href=\"modelica://Modelica.Electrical.MultiPhase.Basic.MultiStar\">MultiStar</a>
    ...
    model MultiStarResistance "Resistance connection of star points"
      ...
      Modelica.Electrical.MultiPhase.Basic.MultiStar multiStar(m=m) annotation (
         Placement(transformation(
            ...
            rotation=0,
            origin={-50,0})));
      Modelica.Electrical.MultiPhase.Basic.Resistor resistor(m=mBasic, final R=
            fill(R, mBasic)) annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=0,
            origin={0,0})));
    ...
    equation
      ...
      connect(resistor.plug_n, star.plug_p) annotation (Line(
          points={{10,0},{40,0},{40,6.66134e-016}},
          color={0,0,255},
          smooth=Smooth.None));
    ...
    equation
      ...
      annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,
            ...
            Text(
              ...
              lineColor={0,0,0},
              textString="%m"),
            Line(points={{70,0},{90,0}}, color={0,0,255})}), Documentation(
            revisions="<html>
</html>", info="<html>
<p>
