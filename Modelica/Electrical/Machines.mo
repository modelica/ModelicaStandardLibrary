...
package Machines "Library for electric machines" 
  ...
  annotation (
  version="1.8.9c", versionDate="2010-02-057",
...
<a href=\"Modelica://Modelica.UsersGuide.ModelicaLicense\">here</a>.</i>
  ...
  <li> v1.8.9c 2010/02/05 Anton Haumer<br>
...
Default machine parameters of model <i>AIM_SlipRing</i> are used.
      ...
      Utilities.TerminalBox TerminalBox1(StarDelta="D") 
        annotation (extent=[-20,-30; 0,-10]);
      Utilities.SwitchedRheostat switchedRheostat(tStart=tStart2, RStart=Rstart) 
    ...
    equation 
      ...
      connect(TerminalBox1.plugToGrid, CurrentRMSsensor1.plug_n) annotation (
          ...
          rgbfillColor={135,135,135},
          fillPattern=1));
      connect(switchedRheostat.plug_p, AIMS1.plug_rp) annotation (points=[-30,
            -34; -20,-34], style(color=3, rgbcolor={0,0,255}));
      connect(switchedRheostat.plug_n, AIMS1.plug_rn) annotation (points=[-30,
            -46; -20,-46], style(color=3, rgbcolor={0,0,255}));
    end AIMS_start;
...
choosing Y-connection (StarDelta=Y) or D-connection (StarDelta=D).
      ...
      model SwitchedRheostat "Rheostat which is shortened after a given time" 
        ...
        Modelica.Electrical.Analog.Basic.Ground ground 
          annotation (extent=[-90,-70; -70,-50],    rotation=-90);
        Modelica.Electrical.MultiPhase.Ideal.IdealCommutingSwitch 
          idealCommutingSwitch(final m=m) 
          annotation (extent=[50,10; 30,30],  rotation=-90);
        Modelica.Electrical.MultiPhase.Basic.Resistor rheostat(
          final m=m, final R=fill(RStart, m)) 
        ...
        annotation (Diagram, Icon(
            Rectangle(extent=[26,40; 54,-40], style(
                color=3,
                rgbcolor={0,0,255},
                fillColor=7,
                rgbfillColor={255,255,255})),
            Line(points=[100,60; -40,60; -40,40], style(color=3, rgbcolor={0,0,255})),
            Line(points=[100,-60; -40,-60; -40,-40], style(color=3, rgbcolor={0,0,255})),
            Ellipse(extent=[-44,40; -36,32], style(color=3, rgbcolor={0,0,255})),
            Ellipse(extent=[-44,-32; -36,-40], style(color=3, rgbcolor={0,0,255})),
            Line(points=[-80,40; -42,-34], style(color=3, rgbcolor={0,0,255})),
            Line(points=[40,40; 40,42; 40,60], style(color=3, rgbcolor={0,0,255})),
            Line(points=[40,-40; 40,-60], style(color=3, rgbcolor={0,0,255})),
            Line(points=[10,-80; 70,-80],   style(color=3, rgbcolor={0,0,255})),
            Line(points=[40,-60; 40,-80],   style(color=3, rgbcolor={0,0,255})),
            Line(points=[20,-90; 60,-90],   style(color=3, rgbcolor={0,0,255})),
            Line(points=[30,-100; 50,-100],   style(color=3, rgbcolor={0,0,255}))));
      equation 
        connect(idealCommutingSwitch.plug_p, plug_p) 
          annotation (points=[40,30; 40,60; 100,60], style(color=3, rgbcolor={0,0,255}));
        connect(plug_n, idealCommutingSwitch.plug_n2) 
          annotation (points=[100,-60; 40,-60; 40,10], style(color=3, rgbcolor={0,0,255}));
        connect(rheostat.plug_p, idealCommutingSwitch.plug_n1) 
          annotation (points=[0,-20; 35,-20; 35,10], style(color=3, rgbcolor={0,0,255}));
        connect(rheostat.plug_n, starRheostat.plug_p) 
          annotation (points=[-20,-20; -40,-20], style(color=3, rgbcolor={0,0,255}));
        connect(star.pin_n, starRheostat.pin_n) 
          annotation (points=[-60,-60; -60,-20], style(color=3, rgbcolor={0,0,255}));
        connect(ground.p, star.pin_n) 
          annotation (points=[-70,-60; -60,-60], style(color=3, rgbcolor={0,0,255}));
        connect(star.plug_p, idealCommutingSwitch.plug_n2) 
          annotation (points=[-40, -60; 40,-60; 40,10], style(color=3, rgbcolor={0,0,255}));
        connect(booleanStep.y, idealCommutingSwitch.control) 
          annotation (points=[-39,20; 32,20], style(color=5, rgbcolor={255,0,255}));
      ...
      model RampedRheostat "Rheostat with linearly decreasing resistance" 
        ...
        Modelica.Electrical.MultiPhase.Basic.Star star(final m=m) 
          annotation (extent=[-20,-70; -40,-50]);
        Modelica.Electrical.Analog.Basic.Ground ground 
          annotation (extent=[-80,-70; -60,-50],    rotation=-90);
        ...
        annotation (Diagram, Icon(
            ...
            Line(points=[20,-90; 60,-90],   style(color=3, rgbcolor={0,0,255})),
            Line(points=[30,-100; 50,-100],   style(color=3, rgbcolor={0,0,255})),
            Line(points=[40,40; 40,60; 100,60], style(
                color=3,
                rgbcolor={0,0,255},
                fillColor=7,
                rgbfillColor={255,255,255},
                fillPattern=1)),
            Rectangle(extent=[-100,40; -20,-40], style(
                color=3,
                rgbcolor={0,0,255},
                fillColor=7,
                rgbfillColor={255,255,255},
                fillPattern=1)),
            Line(points=[-90,24; -72,24; -30,-30], style(
                color=3,
                rgbcolor={0,0,255},
                fillColor=7,
                rgbfillColor={255,255,255},
                fillPattern=1)),
            Polygon(points=[-20,6; -10,0; -20,-6; -20,6], style(
                color=3,
                rgbcolor={0,0,255},
                fillColor=7,
                rgbfillColor={255,255,255},
                fillPattern=1)),
            Polygon(points=[10,6; 20,0; 10,-6; 10,6], style(
                color=3,
                rgbcolor={0,0,255},
                fillColor=7,
                rgbfillColor={255,255,255},
            ...
            Line(points=[20,0; 26,0], style(
                ...
                fillPattern=1))));
      equation 
        connect(plug_p, rheostat.plug_p) annotation (points=[100,60; 60,60; 60,
              10], style(color=3, rgbcolor={0,0,255}));
        connect(rheostat.plug_n, plug_n) annotation (points=[60,-10; 60,-60;
              100,-60], style(color=3, rgbcolor={0,0,255}));
        connect(ramp.y, rheostat.R) annotation (points=[1,0; 25.5,0; 25.5,
              -1.83691e-015; 50,-1.83691e-015], style(color=74, rgbcolor={0,0,
                127}));
        connect(rheostat.plug_n, star.plug_p) annotation (points=[60,-10; 60,
              -60; -20,-60], style(color=3, rgbcolor={0,0,255}));
        connect(star.pin_n, ground.p) annotation (points=[-40,-60; -60,-60],
            style(color=3, rgbcolor={0,0,255}));
      end RampedRheostat;
