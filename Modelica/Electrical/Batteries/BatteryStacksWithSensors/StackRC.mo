...
<p>
This is a stack of <code>Ns</code> x <code>Np</code> transient <a href=\"modelica://Batteries.StacksWithMeasurement.CellRC\">cellRC[Np=1, Ns=1]</a> (with RC-elements) with measurement, arranged in a matrix.
</p>
</html>"));
end StackRC;
