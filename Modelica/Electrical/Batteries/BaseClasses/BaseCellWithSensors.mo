...
equation
  ...
  connect(multiSensor.power, cellBus.p) annotation (Line(points={{-71,-6},{-90,-6},
          {-90,-80},{-59.95,-80},{-59.95,-79.95}}, color={0,0,127}));
  ...
  connect(heatFlowSensor.Q_flow, cellBus.losses) annotation (Line(points={{-11,-60},
...
<p>
This is a single <a href=\"modelica://Batteries.BatteryStacks.CellStack\">cell[Np=1, Ns=1]</a> with measurement.
</p>
</html>"));
