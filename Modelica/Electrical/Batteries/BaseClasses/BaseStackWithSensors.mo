...
<p>
This is a stack of <code>Ns</code> x <code>Np</code> <a href=\"modelica://Batteries.StacksWithMeasurement.Cell\">cell[Np=1, Ns=1]</a> with measurement, arranged in a matrix.
</p>
</html>"));
