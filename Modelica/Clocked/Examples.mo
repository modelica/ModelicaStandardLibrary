...
<dd><b>Engine Timing Model with Closed Loop Control</b>.
    ...
    package Utilities
      ...
      package ComponentsThrottleControl
        ...
        protected
          Real m_ai(start=0, fixed=true, quantity="Mass", unit="g") "Mass";
          NonSIunits.Angle_deg f_Theta "Auxiliary variable";
          Real g_Pm "Auxiliary variable";
        public
          Modelica.Blocks.Interfaces.RealInput Theta(quantity="Angle", unit="deg") "Throttle angle (deg)"
            annotation (Placement(transformation(extent={{-140,40},{-100,80}})));
          Modelica.Blocks.Interfaces.RealInput Pm(quantity="Pressure", unit="bar")
            "Intake manifold presure, bar"
            annotation (Placement(transformation(extent={{-140,-80},{-100,-40}})));
          Modelica.Blocks.Interfaces.RealOutput m_ai_der(quantity="MassFlowRate", unit="g/s")
...
*/
        ...
        block IntakeManifold "Dynamics of the intake manifold"
          ...
          Modelica.Blocks.Interfaces.RealInput m_ai_der(quantity="MassFlowRate", unit="g/s")
            "Mass flow rate of air into manifold (g/s) "
            annotation (Placement(transformation(extent={{-140,40},{-100,80}})));
          Modelica.Blocks.Interfaces.RealInput N(quantity="AngularVelocity", unit="rad/s") "Engine speed (rad/sec)"
            annotation (Placement(transformation(extent={{-140,-80},{-100,-40}})));
          Modelica.Blocks.Interfaces.RealOutput m_ao_der(quantity="MassFlowRate", unit="g/s")
            "Mass flow rate of air out of manifold (g/s)"
            annotation (Placement(transformation(extent={{100,50},{120,70}})));
          Modelica.Blocks.Interfaces.RealOutput P_m(start=P_0, fixed=true, quantity="Pressure", unit="bar")
            "Intake manifold presure, (bar)"
        ...
        extends Modelica.Blocks.Icons.Block;
          ...
          Modelica.Blocks.Interfaces.RealInput N(quantity="AngularVelocity", unit="rad/s") "Engine speed (rad/sec)"
            annotation (Placement(transformation(extent={{-140,-80},{-100,-40}})));
          Modelica.Blocks.Interfaces.RealOutput T_torque_e(quantity="Torque", unit="N.m")
        ...
        block SpeedControl
          ...
          Modelica.Blocks.Interfaces.RealInput N_des(quantity="AngularVelocity", unit="rad/s") "Desired speed, (rad/s)" annotation (Placement(transformation(extent={{-140,20},{-100,60}})));
          Modelica.Blocks.Interfaces.RealInput N(quantity="AngularVelocity", unit="rad/s") "Measured speed, (rad/s)" annotation (Placement(transformation(extent={{-140,-80},{-100,-40}})));
          Modelica.Blocks.Interfaces.RealOutput Theta(start=8.9, quantity="Angle", unit="deg")
...
*/
        ...
        extends Modelica.Blocks.Icons.Block;
          ...
          Modelica.Blocks.Interfaces.RealOutput m_a(quantity="Mass", unit="g")
            "Mass of an cylinder air charge (g)"
            annotation (Placement(transformation(extent={{100,-10},{120,10}})));
          Modelica.Blocks.Interfaces.RealInput m_ao_der(quantity="MassFlowRate", unit="g/s")
            "Mass flow rate of air out of manifold (g/s)"
          ...
          Clocked.ClockSignals.Interfaces.ClockInput clock annotation (
              Placement(transformation(
                ...
                origin={0,-120})));
        protected
          Real m_a_total(start=0, fixed=true, quantity="Mass", unit="g")
            "Total amount of air that was sucked in";
          Real m_a_last(quantity="Mass", unit="g") "Amount of air sucked in until last clock event";
        equation
        ...
        extends Modelica.Blocks.Icons.Block;
          Modelica.Blocks.Interfaces.RealInput m_a(quantity="Mass", unit="g")
            ...
            annotation (Placement(transformation(extent={{-140,-20},{-100,20}})));
          Modelica.Blocks.Interfaces.RealOutput m_a_delayed(quantity="Mass", unit="g")
            "180 deg delayed mass of cylinder air charge (g)"
            annotation (Placement(transformation(extent={{100,-10},{120,10}})));
        protected
          Real m_a_sampled(start=0.152, fixed=true, quantity="Mass", unit="g");
          Real m_a_delayedSampled(start=0.152, fixed=true, quantity="Mass", unit="g");
        public
          Clocked.ClockSignals.Interfaces.ClockInput clock annotation (
              Placement(transformation(
                extent={{-20,-20},{20,20}},
