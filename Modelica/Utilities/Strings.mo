...
package Strings "Operations on strings"
  ...
  external "C" result = ModelicaStrings_length(string) annotation(Include="#include \"ModelicaStrings.h\"", Library="ModelicaExternalC");
...
Returns the number of characters of \"string\".
  ...
  external "C" result = ModelicaStrings_substring(string,startIndex,endIndex) annotation(Include="#include \"ModelicaStrings.h\"", Library="ModelicaExternalC");
    annotation (Documentation(info="<html>
<h4>Syntax</h4>
<blockquote><pre>
...
defined by the optional argument \"string\".
  ...
  external "C" result = ModelicaStrings_compare(string1, string2, caseSensitive) annotation(Include="#include \"ModelicaStrings.h\"", Library="ModelicaExternalC");
    annotation (Documentation(info="<html>
<h4>Syntax</h4>
<blockquote><pre>
...
s2 = Strings.sort(s1);
  ...
  pure function hashString "Create a hash value of a string"
    ...
    external "C" hash=  ModelicaStrings_hashString(string)
       annotation(Include="#include \"ModelicaStrings.h\"", Library="ModelicaExternalC");
    annotation (Documentation(info="<html>
<h4>Syntax</h4>
<blockquote><pre>
...
part of the string is printed.
  ...
  package Advanced "Advanced scanning functions"
    ...
    pure function scanReal "Scan a signed real number"
      ...
      output Real number "Value of Real number";
      external "C" ModelicaStrings_scanReal(string, startIndex, unsigned, nextIndex, number) annotation(Include="#include \"ModelicaStrings.h\"", Library="ModelicaExternalC");
      annotation (Documentation(info="<html>
<h4>Syntax</h4>
<blockquote><pre>
...
<a href=\"modelica://Modelica.Utilities.Strings.Advanced\">Strings.Advanced</a>.
    ...
    pure function scanInteger "Scan signed integer number"
      ...
      output Integer nextIndex
        "Index after the found token (success=true) or index at which scanning failed (success=false)";
      output Integer number "Value of Integer number";
      external "C" ModelicaStrings_scanInteger(string, startIndex, unsigned, nextIndex, number) annotation(Include="#include \"ModelicaStrings.h\"", Library="ModelicaExternalC");
      annotation (Documentation(info="<html>
<h4>Syntax</h4>
<blockquote><pre>
...
<a href=\"modelica://Modelica.Utilities.Strings.Advanced\">Strings.Advanced</a>.
    ...
    pure function scanString "Scan string"
      ...
      external "C" ModelicaStrings_scanString(string, startIndex, nextIndex, string2) annotation(Include="#include \"ModelicaStrings.h\"", Library="ModelicaExternalC");
      annotation (Documentation(info="<html>
<h4>Syntax</h4>
<blockquote><pre>
...
<a href=\"modelica://Modelica.Utilities.Strings.Advanced\">Strings.Advanced</a>.
    ...
    pure function scanIdentifier "Scan simple identifiers"
      ...
      external "C" ModelicaStrings_scanIdentifier(string, startIndex, nextIndex, identifier) annotation(Include="#include \"ModelicaStrings.h\"", Library="ModelicaExternalC");
...
<a href=\"modelica://Modelica.Utilities.Strings.Advanced\">Strings.Advanced</a>.
    ...
    pure function skipWhiteSpace "Scan white space"
      ...
      input Integer startIndex(min=1)=1;
      output Integer nextIndex;
      external "C" nextIndex = ModelicaStrings_skipWhiteSpace(string, startIndex) annotation(Include="#include \"ModelicaStrings.h\"", Library="ModelicaExternalC");
      annotation (Documentation(info="<html>
<h4>Syntax</h4>
<blockquote><pre>
